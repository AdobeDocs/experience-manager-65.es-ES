...
+ Introducción {#getting-started}
   ...
   + Tutorial: Crear el primer formulario adaptable {#create-first-adaptive-form}
      ...
      + [Tutorial: Publicar el formulario adaptable](/help/forms/using/publish-your-adaptive-form.md)
   ...
   + Colaterales de referencia de AEM Forms {#aem-forms-reference-collaterals}
      + [Configure y configure el sitio de referencia de We.Gov y We.Finance](/help/forms/using/forms-install-configure-gov-reference-site.md)
      + [Recorrido por el sitio web de referencia We.Gov y We.Finance](/help/forms/using/forms-gov-reference-site-user-demo.md)
...
+ Instalación y configuración de AEM Forms {#install-aem-forms}
   ...
   + Instalación de AEM Forms en OSGi {#osgi-installation}
      + [Plataformas compatibles con AEM formularios en OSGi](https://docs.adobe.com/content/help/es-ES/experience-manager-65/deploying/introduction/technical-requirements.html)
...
+ Administrar AEM Forms {#manage-administer-aem-forms}
   ...
   + Endurecimiento del entorno de AEM Forms {#hardening-aem-forms-environment}
      ...
      + [Compatibilidad con OAuth2 para el servicio de correo](using/oauth2-support-for-mail-service.md)
...
+ Comunicaciones interactivas {#interactive-communications}
   ...
   + [Generación de varias comunicaciones interactivas](using/generate-multiple-interactive-communication-using-batch-api.md)
...
+ Flujos de trabajo {#workflows}
   ...
   + [Inicio de sesión en flujos de trabajo de AEM Forms](/help/forms/using/forms-workflow-logs.md)
   ...
   + [Configurar fuera de Office](using/configure-out-of-office-settings.md)
...
+ Integración de AEM Forms con las soluciones de Experience Cloud {#integrate-aem-forms-with-experience-cloud-solutions}
   ...
   + [Integración con Adobe Analytics](using/integrate-aem-forms-with-adobe-analytics.md)
...
+ Ayuda del administrador para AEM Forms en JEE {#administrator-help}
   ...
   + Configuración de extensiones de Acrobat Reader DC {#configure-acrobat-reader-dc-extensions}
      ...
      + [Actualización de certificados de servicio de extensión de Reader caducados](/help/forms/using/admin-help/updating-expired-reader-extension-certificates.md)
...
+ Referencia del desarrollador {#developer-reference}
   ...
   + Programación con AEM Forms en JEE {#programming-aem-forms-jee}
      ...
      + Inicio rápido de la API de Java: ejemplos de código {#java-api-quick-start-code-examples}
         ...
         + [Inicio rápido de la API de Java del servicio de extensiones de Acrobat Reader DC (SOAP)](developing/acrobat-reader-dc-extensions-service.md)
