---
title: Inicio rápido (SOAP) de API del servicio de cifrado Java&trade
description: Aprenda a cifrar, quitar el cifrado basado en contraseña/certificado, desbloquear y determinar el tipo de cifrado para documentos de PDF mediante la API de Java&trade; en modo SOAP.
contentOwner: admin
...
[Inicio rápido (modo SOAP): Eliminación del cifrado basado en contraseña mediante Java](encryption-service-java-api-quick.md#quick-start-soap-mode-removing-password-based-encryption-using-the-java-api)
...
[Inicio rápido (modo SOAP): Determinación del tipo de cifrado mediante Java](encryption-service-java-api-quick.md#quick-start-soap-mode-determining-encryption-type-using-the-java-api)
