...
El siguiente ejemplo de código procesa un formulario denominado *Loan.xdp* en el cliente mediante la API de Java del servicio de Forms. Observe que el diseño de formulario forma parte de una aplicación y se hace referencia a él mediante el valor URI raíz de contenido `repository:///`. (Consulte [Representación de Forms en el cliente](/help/forms/developing/rendering-forms.md#rendering-forms-at-the-client)).
