...
Para obtener información sobre cómo mostrar datos de proceso en un control gráfico de Flex, consulte [Visualización de datos de proceso de AEM Forms en gráficos de Flex](https://www.adobe.com/devnet/livecycle/articles/populating_flexcontrols.html).
...
1. Llame al de ChannelSet `login` o el método del servicio `setCredentials` para especificar el valor del identificador de usuario y la contraseña. (Consulte [Usar el inicio de sesión único](invoking-aem-forms-using-remoting.md#using-single-sign-on).)
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td><p>Especifica el valor del identificador de cliente al que pertenece la nueva cuenta. Este cuadro de texto se rellena con el valor devuelto por el <code>createCustomer</code> operación. </p></td>
  </tr>
 </tbody>
</table>
...
En el ejemplo de código siguiente se invoca el servicio Customer y se crea un cliente nuevo. Cuando ejecute este ejemplo de código, asegúrese de rellenar todos los cuadros de texto. Además, asegúrese de crear el archivo Customer.as que se asigna a `com.adobe.livecycle.sample.customer.Customer`.
