...
Para utilizar los recursos que proporciona el ejemplo en el artículo, descargue el paquete de muestra tal como se explica en la siguiente sección, [Paquete de muestra](../../forms/using/synchronizing-adaptive-forms-xfa.md#p-sample-package-p).
...
Cuando se abre un formulario adaptable que no está sincronizado con el archivo XDP para la creación la próxima vez, se muestra el siguiente mensaje: **Se ha actualizado la plantilla de Esquema/formulario para el formulario adaptable. `Click Here` para volver a basarlo en la nueva versión.**
...
>[!NOTE]
>
>No se cambió la etiqueta Campo numérico AF porque se ha sobrescrito esta propiedad del cuadro de diálogo de propiedades de componente, como se describe en [Añadir contenido a formularios adaptables](../../forms/using/synchronizing-adaptive-forms-xfa.md#p-add-content-to-adaptive-form-br-p).
