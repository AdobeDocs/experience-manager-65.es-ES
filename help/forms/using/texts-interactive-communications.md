...
1. Select **[!UICONTROL Crear]** > **[!UICONTROL Texto]**.
...
* Para insertar una propiedad del modelo de datos de formulario en texto, coloque el cursor donde desee insertar la propiedad y, a continuación, seleccione la opción **[A]** propiedad en el panel izquierdo tocando en él y puntee **[!UICONTROL [B] Agregar selección]**. También puede pulsar dos veces la propiedad para insertarla en el **[C]** posición del cursor. Las propiedades del modelo de datos de formulario se resaltan en un color de fondo parduzco.
...
1. Toque **[!UICONTROL Crear regla]**.
   ...
   * Cualquier variable que pueda haber creado
   ...
   ![editor de reglas](assets/ruleeditor.png) ![ruleeditorfdm](assets/ruleeditorfdm.png)
