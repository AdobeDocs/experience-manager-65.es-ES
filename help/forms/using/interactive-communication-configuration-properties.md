...
Toque Configuración **de formularios** adaptables y Canales web de comunicación interactiva en la página de configuración **de la consola web de** Adobe Experience Manager para vista de las propiedades de configuración de formularios adaptables y canal web de comunicaciones interactivas. En la tabla siguiente se describen las propiedades relacionadas con Interactive Communications:
...
Toque Configuración **del tema del Canal web de formulario** adaptable y comunicación interactiva en la página de configuración **de la consola web de** Adobe Experience Manager para realizar la vista de las propiedades de configuración de las temáticas de canal web de formularios adaptables y comunicaciones interactivas.
...
<table>
 <tbody> 
  ...
  <tr> 
   ...
   <td>Lista de las fuentes disponibles para usar al crear formularios adaptables y comunicaciones interactivas.</td> 
