...
1. Abrir propiedades del contenedor **[!UICONTROL de formulario]** adaptable. En el navegador de propiedades, vaya a **[!UICONTROL Básico]** > Tema **[!UICONTROL de formulario]** adaptable. El campo Tema **[!UICONTROL de formulario]** adaptable lista todas las temáticas integradas y personalizadas. De forma predeterminada, se aplica el tema Lienzo.
1. Seleccione un tema en el campo Tema **[!UICONTROL de formulario]** adaptable. Por ejemplo, el tema **de** Encuesta. Toque ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png) para aplicar el tema seleccionado.
...
1. Cambie el logotipo y el texto existentes del encabezado. Para eliminar el logotipo:
   ...
   1. Toque la imagen del logotipo en el componente de [!UICONTROL encabezado] y toque ![las](assets/cmppr.png) propiedades **[!UICONTROL cmppr]**. En la propiedad de [!UICONTROL imagen] , toque X para eliminar la imagen del logotipo existente.
   1. Toque **[!UICONTROL cargar]**, seleccione el logo.png y toque ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png) para guardar los cambios. La imagen se ha descargado en la sección [Antes del inicio](/help/forms/using/style-your-adaptive-form.md#before-you-start) .
   1. Toque texto del encabezado `We.Retail`y toque ![aem_6_3_edit](assets/aem_6_3_edit.png) **[!UICONTROL edit]**. Cambiar el texto del encabezado a `we retail`. Aplicar formato de negrita solo a `we`la `we retail`.
...
1. Elimine el título y añada texto de marcador de posición:
   ...
   1. Copie el contenido del campo **[!UICONTROL Título]** en el campo Texto **[!UICONTROL del]** marcador de posición.
...
1. Toque **[!UICONTROL Crear]**. Se crea un tema y un cuadro de diálogo para abrir el formulario y editarlo. Toque **[!UICONTROL Abrir]** para abrir el tema recién creado en una ficha nueva. El tema se abre en el editor de temas. Para aplicar estilo, el editor de temas utiliza un formulario adaptable incorporado que se incluye con AEM [!DNL Forms].
...
1. Puntee en Opciones **** de tema ![opciones](assets/theme-options.png) de tema > **[!UICONTROL Configurar]**. En el campo Formulario **[!UICONTROL de]** Previsualización, seleccione el formulario adaptable **Shipping-address-add-update-form** , toque ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png)y **[!UICONTROL Guardar]**. Ahora, el editor de temas está configurado para utilizar su propio formulario adaptable en lugar del formulario adaptable predeterminado. Toque **[!UICONTROL Cancelar]** para volver al editor de temas.
...
1. Vaya a la opción **[!UICONTROL Encabezado]** > **[!UICONTROL Texto]** en el panel Selectores. El panel Selectores se encuentra a la izquierda del editor de temas. Si el panel no está visible, toque ![alternar panel](assets/toggle-side-panel.png) lateral Alternar panel lateral.
...
1. Toque el widget de [!UICONTROL encabezado] y toque **[!UICONTROL Encabezado]**. Las opciones para aplicar estilo al widget de encabezado aparecen a la izquierda. Expanda el acordeón **[!UICONTROL Dimension y posición]** , defina la **[!UICONTROL altura]** en `120px`y toque ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
1. Expanda el acordeón **[!UICONTROL Fondo]** del widget de encabezado, defina el color **[!UICONTROL de]** fondo en `F6921E.`
...
1. Puntee en el widget de pie de página y toque **[!UICONTROL Pie de página]**. Expanda el acordeón **[!UICONTROL Fondo]** , defina el color **[!UICONTROL de]** fondo en `F6921E`y toque ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Toque el campo ID **** del cliente y toque la opción Utilidad **[!UICONTROL de campo]** . Defina las siguientes propiedades y toque ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Toque en el área vacía sobre el campo ID **** del cliente y toque el Contenedor **[!UICONTROL del panel]** interactivo. Establezca el **[!UICONTROL Fondo]** > Color **[!UICONTROL de]** fondo en F1F2F2. Toque ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Toque el botón **[!UICONTROL Adjuntar]** y toque el ![icono aem_6_3_](assets/aem_6_3_edit.png)editicon. Defina las siguientes propiedades en el acordeón **[!UICONTROL Dimension y Posición]** :
...
1. Toque la opción de prueba **[!UICONTROL de dirección aprobada por el]** gobierno y toque el ![icono aem_6_3_](assets/aem_6_3_edit.png)editicon. Establezca las siguientes propiedades:
