...
* Un usuario Experience Manager con [Forms Author](/help/forms/using/forms-groups-privileges-tasks.md) y [Administrador de Forms](/help/forms/using/forms-groups-privileges-tasks.md) privilegios
...
* [Configurar una acción de envío](configuring-submit-actions.md)
