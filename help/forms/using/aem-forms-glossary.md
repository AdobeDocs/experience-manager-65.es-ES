...
[Formularios adaptables](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/create-an-adaptive-form-on-forms-cs/creating-adaptive-form)
...
[Versiones de formulario adaptable](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/adaptive-forms-core-components/add-versioning-reviews-comments)
...
## Integración de Adobe Analytics Forms

[Integración de Adobe Analytics Forms](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/integrate/services/enable-adobe-analytics-adaptive-form-using-experience-cloud-setup-automation)
...
## Paquete de complemento de AEM Forms
...
Una aplicación implementada en Adobe Experience Manager (AEM) como paquete que contiene servicios (proveedores de API) y servlets o JSP administrados por el marco de trabajo de AEM Sling.
...
AEM Forms en el entorno OSGi es un paquete estándar de AEM Author o AEM Publish con AEM Forms implementado en él. Puede ejecutar AEM Forms en OSGi en un entorno de servidor único, configuración de granjas y de clústeres. La configuración de clúster solo está disponible para instancias de autor de AEM.

## Adobe Sign en AEM Forms

[Adobe Sign en AEM Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/adaptive-forms-advanced-authoring/adobe-sign-integration-adaptive-forms)
...
API proporcionadas por la capa web de AEM Forms para el consumo remoto por clientes basados en HTTP, como los formularios móviles SDK.Funcionalidades de AEM Forms que permiten la creación, el ensamblado, la distribución y el archivado de documentos de PDF, la adición de firmas digitales y la descodificación de Forms con códigos de barras.

| **Nombre de servicio** | **Descripción** | **Vínculo de documentación** |
|------------------------------|---------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|
| **Servicio de Forms** | Procese PDF forms con plantillas y XML, integre datos de formulario para importar o exportar y admita el procesamiento basado en fragmentos. | [Documentación del servicio Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/output-service) |
| **Servicio de salida** | Genera documentos combinando datos con plantillas en formatos como PDF, PCL o PostScript. | [Documentación del servicio de salida](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/output-service) |
| **Servicio del ensamblador** | Combina, reorganiza, valida y aumenta documentos de PDF y XDP. | [Documentación del servicio Assembler](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/assembler-service) |
| **Servicio ConvertPDF** | Convierte documentos de PDF a PostScript o formatos de imagen como PNG, JPEG o TIFF. | [Documentación del servicio ConvertPDF](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/using-convertpdf-service) |
...
| **Servicio DocAssurance** | Cifra, descifra, firma digitalmente y aplica directivas de seguridad de documentos a los archivos PDF. | [Documentación del servicio DocAssurance](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/overview-aem-document-services#doc-assurance-service) |
| **Servicio de PDF Generator** | Convierte formatos de archivo nativos (por ejemplo: Microsoft Word, Excel) en documentos de PDF. | [Documentación del servicio PDF Generator](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/aem-document-services-programmatically#pdfgeneratorservice) |

## API de comunicación de Forms as a Cloud Service

[API de comunicación de Forms as a Cloud Service](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction)
...
| **Nombre de servicio** | **Descripción** | **Vínculo de documentación** |
|-------------------------------|------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|
| **Generación de documentos** | Combinar una plantilla (XFA o PDF) con datos XML para generar documentos en PDF y formatos de impresión como PS, PCL, DPL, IPL y ZPL. | [Documentación de generación de documentos](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction.html#document-generation) |
| **Manipulación de documentos** | Combinar y reorganizar documentos de PDF. | [Documentación de manipulación de documentos](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction#document-manipulation) |
| **Conversión de documento** | Conversión de un PDF a PDF/A y comprobación de la compatibilidad con PDF/A. | [Documentación de conversión de documentos](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction#document-conversion) |
| **Documento Assurance** | Agregue o quite campos de firma, firme, certifique, cifre, descifre y aplique derechos de uso a documentos de PDF. | [Documentación de Document Assurance](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction#doc-assurance) |
...
[Archetype](https://experienceleague.adobe.com/es/docs/experience-manager-core-components/using/developing/archetype/overview)

Plantilla o patrón en AEM utilizado para generar un nuevo proyecto con una estructura predefinida, lo que facilita la estandarización, la configuración rápida y el cumplimiento de las prácticas recomendadas de desarrollo de AEM.

## Instancia de autor

[Instancia de autor](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/publish-process-aem-forms/publishing-unpublishing-forms)
...
[Crear front-end](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/install-aem-forms/aem-forms-architecture-deployment#architecture)

Una interfaz de usuario para crear y administrar formularios en AEM Forms.

## Bloque de formulario adaptable
...
[Administración de correspondencia](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/letters-correspondences/cm-overview)
...
El repositorio de contenido Java (JCR) integrado en AEM que almacena datos estructurados y no estructurados, lo que permite el almacenamiento jerárquico de contenido, plantillas y configuraciones.
...
## XCI personalizado (información de configuración XML)

[XCI personalizado (información de configuración XML)](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/administrator-help/configure-forms/specifying-xci-configuration-options)
...
[Integración de datos](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/form-data-model/data-integration)
...
[Fuentes de datos](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/form-data-model/configure-data-sources)
...
[Fragmentos de documento](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/letters-correspondences/lists)
...
## Integración de Forms

[Integración de Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/form-data-model/data-integration)
...
[Revisión de formulario](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/create-reviews-forms)

Una función controlada por el flujo de trabajo que permite a las partes interesadas revisar formularios adaptables, agregar anotaciones y aprobar cambios antes de publicar. Utiliza la bandeja de entrada AEM y la administración de tareas.
...
Una capa de representación que conecta formularios adaptables a fuentes de datos back-end y permite la integración con servicios web RESTful, servicios de SOAP y OData. FDM permite a los autores de formularios asignar campos de formulario directamente a estructuras de datos back-end, lo que garantiza una sincronización perfecta de la entrada del usuario con sistemas externos.

## Localización de formularios

[Localización de formularios](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/supporting-new-language-localization)
...
[Portal de formularios](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-forms-portal/creating-form-portal-page)

Los componentes del portal de Forms permiten a los desarrolladores web crear y personalizar un portal de Forms en sitios web creados con Adobe Experience Manager (AEM). Permite a los usuarios descubrir, acceder y enviar formularios de forma eficaz en las plataformas web y móviles.

## Front-end Procesamiento y envío de formularios

[Front-end Procesamiento y envío de formularios](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/install-aem-forms/aem-forms-architecture-deployment#architecture)
...
[Conjuntos de formularios](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/html5-forms/formset-in-aem-forms)
...
## Flujo de trabajo centrado en Forms

[Flujo de trabajo centrado en Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/workflows/aem-forms-workflow)
...
[Comunicación interactiva](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/getting-started/interactive-communications-overview)
...
[JCR (repositorio de contenido Java)](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/underlying-technology/introduction-jcr)

Repositorio jerárquico basado en estándares para almacenar contenido, configuraciones y metadatos en AEM, lo que admite el almacenamiento de datos estructurado y no estructurado.
...
[Metadatos en AEM Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/manage-administer-aem-forms/manage-form-metadata)
...
[Instancia de publicación](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/publish-process-aem-forms/publishing-unpublishing-forms)

Entorno en AEM que sirve contenido en directo a los usuarios finales. Ofrece formularios, páginas y otras experiencias digitales con un rendimiento optimizado.

## Editor de reglas

[Editor de reglas](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/rule-editor-core-components/rule-editor-core-components)
...
[Firmas manuscritas](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/add-components-to-an-adaptive-form/signing-forms-using-scribble)
...
## Acción de envío en AEM Forms

[Acción de envío en AEM Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/adaptive-forms-basic-authoring/configuring-submit-actions)
...
[Capa web](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/install-aem-forms/aem-forms-architecture-deployment#architecture)
...
## XDP (paquete de datos XML)

[XDP (paquete de datos XML)](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/manage-administer-aem-forms/get-xdp-pdf-documents-aem)
...
[XFA (arquitectura de formularios en XML)](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/adaptive-forms-basic-authoring/creating-adaptive-form#create-an-adaptive-form-based-on-an-xfa-form-template)

Una tecnología heredada para crear PDF forms dinámico e interactivo. Los formularios XFA permiten funciones avanzadas, como ajustes de diseño dinámico, scripts e integración perfecta con sistemas back-end.

## Esquema XML o JSON

[Esquema XML o JSON](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/adaptive-forms-basic-authoring/creating-adaptive-form#create-an-adaptive-form-based-on-xml-or-json-schema)
