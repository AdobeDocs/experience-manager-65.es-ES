...
* (Opcional) Configurar el período de vaciado de la transacción y las bandejas de salida [](/help/forms/using/installing-configuring-aem-forms-osgi.md)
...
* Utilice las categorías: **Documento procesado**, **Documentos procesados** y **Forms enviado** para ver las transacciones correspondientes. Para el tipo de transacciones contabilizadas en estas categorías, consulte [API de informes de transacciones facturables](../../forms/using/transaction-reports-billable-apis.md).
