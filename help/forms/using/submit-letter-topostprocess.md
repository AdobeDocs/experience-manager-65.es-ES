...
1. **Flujo de trabajo AEM:** AEM flujos de trabajo también se pueden utilizar como procesos posteriores para las cartas enviadas. Instrucciones para la configuración [Flujo de trabajo AEM](../../forms/using/aem-forms-workflow.md).
