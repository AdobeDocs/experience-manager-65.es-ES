...
* **Controlador de tiempo de espera:** seleccione la secuencia de comandos que se ejecutará cuando el paso de asignación de tarea sobrepase la fecha de vencimiento. Los scripts colocados en el repositorio de CRX en [aplicaciones]/fd/panel/scripts/timeoutHandler están disponibles para su selección. La ruta especificada no existe en crx-repository. Un administrador crea la ruta antes de utilizarla.
