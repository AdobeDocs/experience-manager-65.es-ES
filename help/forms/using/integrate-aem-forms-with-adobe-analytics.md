...
![Información general de Analytics](/help/forms/using/assets/analytics-workflow.png)
...
>[!NOTE]
>En el caso de ambas [Analytics heredado](/help/forms/using/configure-analytics-forms-documents.md) y las funciones de Launch Analytics se habilitan simultáneamente, **Launch Analytics** tendrá prioridad.
...
1. Pulse el campo y seleccione ![Editor de reglas](/help/forms/using/assets/edit-rules-icon.svg) para abrir la página del editor de reglas.
