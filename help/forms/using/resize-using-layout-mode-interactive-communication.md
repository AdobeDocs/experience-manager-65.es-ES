...
>[!NOTE]
>
>Si está creando el canal web mediante [Imprimir canal como maestro](../../forms/using/create-interactive-communication.md) para una comunicación interactiva, los componentes disponibles para cambiar el tamaño también incluyen los subformularios y campos que se generan automáticamente en el canal web mediante el canal de impresión. El canal web conserva el diseño de los elementos del canal de impresión en el modo Diseño.

## Acceder al modo Diseño {#access-layout-mode}

Select **Diseño** de la lista desplegable que aparece en la parte superior de la interfaz de creación de comunicaciones interactivas junto a la **Vista previa** . El formulario se muestra en el modo Diseño.

1. Inicie sesión en la instancia de autor de AEM y vaya a **Adobe Experience Manager** > **Forms** > **Forms y documentos**.
1. Crear una nueva o abrir una [Comunicación interactiva](../../forms/using/create-interactive-communication.md).
