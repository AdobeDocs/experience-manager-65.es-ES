...
Datos de administración de usuarios para usuarios que hayan accedido al menos una vez a las aplicaciones de Forms en `https://'[server]:[port]'lc` también se almacena en AEM repositorio.
