...
1. **Bandeja de entrada** de Adobe: Se encuentra el icono [de] celda de la barra de menús superior en el servidor AEM.
...
Aya necesita revisar algunos documentos en casa antes de poder completar la solicitud de servicio. Ella guarda y sale de la aplicación.
...
1. Utilice la siguiente lógica **** dinámica para mostrar la función dinámica mediante el menú desplegable Estado **de la** familia:
   ...
   1. **¿Tienes hijos?**:: (Sí/No) para mostrar el panel dependiente del niño.
      ...
      1. (Agregar o quitar) para agregar o quitar varios paneles dependientes secundarios.
...
**** Esta sección: George es analista de negocios en la agencia gubernamental de la que Aya solicita un servicio. George tiene un único tablero donde puede ver todas las solicitudes de servicio que le han sido asignadas para su revisión.
...
1. En la Bandeja de entrada, abra la última tarea &quot;Revisión **de la aplicación de beneficios** sanitarios&quot;.
...
1. Para una rápida referencia a IC directamente:
   ...
   *https://&lt;aemserver>:&lt;puerto>/content/dam/formsanddocuments/adobe-gov-forms/welcome-handbook/we-gov-welcome-handbook/jcr:content?channel=web&amp;mode=preview&amp;wcmmode=disabled*
...
**** Esta sección: Camila navega a un tablero donde puede ver en todos los KPI de la agencia como el porcentaje de ciudadanos que empiezan a rellenar un formulario de solicitud de servicio y abandonan, el tiempo promedio desde el envío de la solicitud hasta la respuesta de aprobación/denegación, y estadísticas de participación para los manuales de beneficios que ha enviado a los ciudadanos.

### Camila revisa los informes de sitios (Adobe Analytics de We.Gov) {#camila-reviews-sites-reporting-we-gov-adobe-analytics}

1. Vaya a *https://&lt;aemserver>:&lt;puerto>/sites.html/content*
1. Seleccione el &quot;**AEM Forms We.Gov Site**&quot; para ver las páginas del sitio.
...
### Camila revisa los informes de Forms (Adobe Analytics de We.Gov) {#camila-reviews-forms-reporting-we-gov-adobe-analytics}
