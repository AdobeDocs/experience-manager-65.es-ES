...
Para obtener más información sobre los informes predefinidos, consulte Informes [predefinidos en proceso Sistema de informes](/help/forms/using/process-reporting/pre-defined-reports-in-process-reporting.md).

**Consultas ad hoc:** Este elemento contiene opciones para realizar búsquedas basadas en filtros para procesos y tareas.

Para obtener más información sobre consultas ad hoc, consulte Sistema de informes [de Consultas](/help/forms/using/process-reporting/adhoc-queries-in-process-reporting.md)ad-hoc en proceso.
