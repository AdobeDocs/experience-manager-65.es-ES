...
- **Cobertura del paquete de servicio**: Adobe proporciona soporte técnico para entornos AEM Forms que ejecutan cualquier paquete de servicio lanzado en los últimos 18 meses. Si la versión actual no se ajusta a este período de 18 meses, Adobe recomienda encarecidamente actualizar al Service Pack más reciente para mantener un rendimiento, seguridad y asistencia continuos óptimos.
...
>[!NOTE]
>
> Para cualquier consulta relacionada con formatos compatibles o versiones de plataforma, póngase en contacto con el servicio de asistencia de AEM Forms.
...
### Versión 6.5.23.0 (julio de 2025)
