...
* Cuando AEM servidor y la página web están en dominios diferentes, realice los pasos que se enumeran en la sección [permitir que AEM Forms proporcione formularios adaptables a un sitio de dominios cruzados](#cross-site).
...
## Permitir que AEM Forms ofrezca formularios adaptables a un sitio de dominios múltiples {#cross-site}
