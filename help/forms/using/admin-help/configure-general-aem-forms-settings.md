...
>[!NOTE]
>
>Asegúrese de que el directorio temporal está en el sistema de archivos local. Los formularios AEM no admiten un directorio temporal en una ubicación remota.
