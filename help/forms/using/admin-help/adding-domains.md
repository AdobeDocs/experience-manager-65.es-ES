...
* La Administración de usuarios no puede diferenciar entre dos nombres de dominio que solo difieran en el uso de caracteres extendidos. Por ejemplo, si crea un dominio llamado *abcde* y un dominio llamado *âbcdè*, se considerarán iguales.
