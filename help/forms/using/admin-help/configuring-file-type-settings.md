...
* Especifique qué configuración de tipo de archivo utilizar de forma predeterminada (consulte [Importar y exportar archivos de configuración del PDF Generator](/help/forms/using/admin-help/importing-exporting-pdf-generator-configuration.md))
...
**Idioma principal de OCR:** El idioma del motor de OCR que se utiliza para identificar los caracteres. El valor predeterminado es Inglés (EE.UU.).
...
1. Si sólo desea incrustar los subconjuntos en uso de las fuentes incrustadas, seleccione **Subconjunto de todas las fuentes incrustadas**.
   ...
   >[!NOTE]
   >
   >*Si utiliza esta opción en combinación con **Desincrustar algunas fuentes**, fuentes en el **Añadir fuentes para desincrustar**aún están completamente desincrustadas.*
...
Estas opciones determinan cómo se convierten los archivos de Microsoft PowerPoint. Para obtener instrucciones sobre el acceso a estas opciones, consulte [Crear o editar la configuración de tipo de archivo](/help/forms/using/admin-help/configuring-file-type-settings.md#create-or-edit-file-type-settings).
...
**[!UICONTROL Convertir estilos especificados en marcadores]**: convierte los estilos definidos en la variable **[!UICONTROL Estilos con niveles]** a marcadores en el documento de PDF.
...
**Codificación Acrobat PDFMaker:** Especifica el tipo de codificación de los archivos de texto sin formato de entrada al PDFMaker de Acrobat. Por ejemplo, si utiliza un archivo codificado en UTF-8, seleccione UTF-8 para obtener los mejores resultados.
...
Estas opciones determinan cómo se convierten los archivos de AutoCAD. Para obtener instrucciones sobre el acceso a estas opciones, consulte [Crear o editar la configuración de tipo de archivo](/help/forms/using/admin-help/configuring-file-type-settings.md#create-or-edit-file-type-settings).
...
Estas opciones determinan cómo se convierten los archivos de OpenOffice. Para obtener instrucciones sobre el acceso a estas opciones, consulte [Crear o editar la configuración de tipo de archivo](/help/forms/using/admin-help/configuring-file-type-settings.md#create-or-edit-file-type-settings).
