...
* Especifique qué configuración de tipo de archivo se usará de forma predeterminada (consulte [Importación y exportación de archivos de configuración del PDF Generator](https://helpx.adobe.com/aem-forms/6-2/admin-help/importing-exporting-pdf-generator-configuration.html))
...
* [Habilitar compatibilidad con el PDF/A](https://helpx.adobe.com/aem-forms/6-2/admin-help/enable-pdf-a-support.html)
...
**Idioma principal de OCRL:** Idioma que debe usar el motor de OCR para identificar los caracteres. El valor predeterminado es Inglés (EE.UU.).
...
1. Rellene la información necesaria en estas secciones:
   ...
   [Importación y exportación de archivos de configuración del PDF Generator](https://helpx.adobe.com/aem-forms/6-2/admin-help/importing-exporting-pdf-generator-configuration.html)
...
1. Si desea incrustar sólo los subconjuntos en uso de las fuentes incrustadas, seleccione **Subestablecer todas las fuentes incrustadas**.
   ...
   >[!NOTE]
   >
   >*Si usa esta opción en combinación con **Desincrustar algunas fuentes**, las fuentes de la lista **A**Agregar fuentes a la lista de desincrustados siguen estando completamente desincrustadas.*
...
Estas opciones determinan cómo se convierten los archivos de Microsoft PowerPoint. Para obtener instrucciones sobre cómo obtener acceso a estas opciones, vea [Crear o editar la configuración de tipo de archivo](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings).
...
Estas opciones determinan cómo se convierten los archivos de AutoCAD. Para obtener instrucciones sobre cómo obtener acceso a estas opciones, vea [Crear o editar la configuración de tipo de archivo](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings).
...
Estas opciones determinan cómo se convierten los archivos de OpenOffice. Para obtener instrucciones sobre cómo obtener acceso a estas opciones, vea [Crear o editar la configuración de tipo de archivo](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings).
