...
**PDF/X-3 2002:** Comprueba la compatibilidad con PDF/X-3 de los trabajos entrantes y crea archivos PDF solo si son compatibles. Al igual que PDF/X-1a, PDF/X-3 es un estándar ISO para el intercambio de contenido gráfico. La diferencia principal es que el PDF/X-3 admite el color independiente del dispositivo.
