...
La impresión en esta impresora desde cualquier aplicación envía el documento (en formato PostScript) a PDF Generator, que convierte el archivo PostScript en PDF. Según la configuración de PDF PDF Generator, este envía el documento al usuario como datos adjuntos a un mensaje de correo electrónico, reenvía el documento al PDF AEM a un servicio o proceso de formularios de un usuario especificado o realiza ambas acciones.
...
1. Para enviar a los PDF AEM convertidos a un servicio o proceso de formularios de, seleccione la opción Reenviar el PDF AEM convertido al servicio de formularios o proceso de formularios especificados y especifique la siguiente información:
