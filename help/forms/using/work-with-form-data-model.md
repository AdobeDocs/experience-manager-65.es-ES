...
1. Seleccionar ![aem_6_3_edit](assets/aem_6_3_edit.png) para que el argumento del servicio de lectura [enlazar el argumento a un atributo de perfil de usuario, atributo de solicitud o valor literal](#bindargument) y especifique el valor de enlace.
