...
1. Seleccione un componente y toque el icono principal. En el menú contextual, toque Contenedor **[!UICONTROL de formulario]** adaptable y, a continuación, el icono de configuración.
...
1. Agregue texto de accesibilidad personalizado a todas las celdas de solo lectura de las tablas. Además, deshabilite todas las celdas de sólo lectura de las tablas.
