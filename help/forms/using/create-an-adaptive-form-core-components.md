...
1. Inicie sesión en [AEM author instance](https://experienceleague.adobe.com/docs/experience-manager-65/deploying/deploying/deploy.html?lang=es#author-and-publish-installs) local.
