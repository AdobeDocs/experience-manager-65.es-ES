...
description: La utilidad de migración le permite migrar recursos y documentos de AEM Forms AEM de Forms AEM 6.3 o versiones anteriores a Forms 6.4, o de la versión 6.3 de la aplicación, de la que se dispone en la versión 6.4.
