...
El cuadro de diálogo **Editar** incluye varias fichas que proporcionan las opciones de configuración descritas en la tabla siguiente. Toque **Aceptar** para guardar la configuración.
...
1. Especifique lo siguiente:
   ...
   * **** Texto: Etiqueta o rótulo del componente Predicado de fecha. El valor predeterminado es Fecha de **última modificación.**
...
1. Toque el componente y, a continuación, toque ![settings_icon](assets/settings_icon.png). Se abre el cuadro de diálogo Editar.
1. En la ficha General, especifique la etiqueta de búsqueda. The default value is **Properties**

1. En la ficha Opciones, toque **Agregar elemento.**
...
Para enumerar los formularios que están en estado borrador y los formularios que ya se han enviado, utilice el componente **[!UICONTROL Borradores y envíos]** . Para obtener más información, consulte [Personalización del componente](../../forms/using/draft-submission-component.md)Borradores y envíos.
...
De forma predeterminada, el portal de formularios proporciona acciones de procesamiento. Puede personalizar el portal de formularios para agregar más acciones. Para obtener información detallada, consulte [Adición de acciones personalizadas en elementos de la lista de formularios.](../../forms/using/add-custom-action-form-lister.md)
