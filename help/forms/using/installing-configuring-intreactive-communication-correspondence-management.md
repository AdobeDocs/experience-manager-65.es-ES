...
AEM Forms es una potente plataforma de clase empresarial. La comunicación interactiva es solo una de las funciones de AEM Forms. Para obtener la lista completa de funciones, consulte [Introducción a AEM Forms](../../forms/using/introduction-aem-forms.md).
