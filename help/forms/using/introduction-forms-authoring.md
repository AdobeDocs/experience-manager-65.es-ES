...
<table>
 <tbody>
  ...
  <tr>
   <td>Captcha</td>
   <td>Agrega validación de CAPTCHA mediante el servicio Google reCAPTCHA. Para obtener más información, consulte <a href="../../forms/using/captcha-adaptive-forms.md" target="_blank">Uso de CAPTCHA en formularios</a>adaptables.</td>
  </tr>
  <tr>
   <td>Gráfico</td>
...
* **Información** de página ![tema-opciones](assets/theme-options.png): Permite ver propiedades de página, publicar o cancelar la publicación de un formulario, iniciar un flujo de trabajo de formulario y abrir el formulario en la IU clásica.
