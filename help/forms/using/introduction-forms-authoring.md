...
* **Emulador** ![ruler](assets/ruler.png): Permite emular el aspecto del formulario para diferentes tamaños de visualización, como tabletas y teléfonos.
...
* **guideContainer**: La raíz de un formulario adaptable, que se marca como **[!UICONTROL Inicio de la forma adaptable]** en la interfaz de usuario del formulario adaptable. En este componente, puede especificar lo siguiente:
