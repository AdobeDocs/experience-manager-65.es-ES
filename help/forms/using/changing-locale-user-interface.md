...
Antes de realizar los pasos anteriores, asegúrese de seguir los pasos enumerados en [Pasos genéricos para personalizar AEM Forms Workspace](../../forms/using/generic-steps-html-workspace-customization.md).

>[!NOTE]
>
>Para cambiar el idioma de la pantalla de inicio de sesión de AEM Forms Workspace, consulte [Crear una nueva pantalla de inicio de sesión](../../forms/using/creating-new-login-screen.md).
...
Se necesita un paquete de desarrollo para localizar la API *datepicker*. Para obtener información detallada sobre la creación de paquetes de desarrollo, consulte [Crear el código de espacio de trabajo de AEM Forms](introduction-customizing-html-workspace.md#building-html-workspace-code).
