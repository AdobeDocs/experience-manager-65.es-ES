...
Para ver los pasos detallados, consulte [Configuración de análisis e informes para formularios](../../forms/using/configure-analytics-forms-documents.md)adaptables.

**Configurar Target**

Para crear y ejecutar pruebas A/B para sus formularios adaptables, configure Target en AEM Forms como se describe en [Configuración e integración de Target en AEM Forms](../../forms/using/ab-testing-adaptive-forms.md#p-set-up-and-integrate-target-in-aem-forms-p).
...
Para obtener más información sobre los informes de análisis de formularios, consulte [Visualización y comprensión de los informes](../../forms/using/view-understand-aem-forms-analytics-reports.md)de análisis de AEM Forms.
...
Para obtener más información sobre la creación de una prueba A/B para un formulario adaptable, consulte Prueba [A/B de formularios](../../forms/using/ab-testing-adaptive-forms.md)adaptables.
