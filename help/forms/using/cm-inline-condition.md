...
1. Para crear una condición para evaluar si el texto seleccionado/condicionalizado aparece en la letra y, a continuación, toque la marca de verificación para guardar la expresión:
   ...
   Para obtener más información sobre la creación de la expresión, consulte **Creación de expresiones y funciones remotas con el creador** de expresiones en el [Generador](../../forms/using/expression-builder.md)de expresiones. El valor especificado en la expresión debe ser compatible con el elemento del diccionario de datos. Para obtener más información, consulte Diccionario [de datos](../../forms/using/data-dictionary.md).
