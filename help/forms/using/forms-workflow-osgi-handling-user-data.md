...
1. Identifique y elimine los datos de borrador y envío sin conexión de AEM [!DNL Forms] bandeja de salida de la aplicación de los participantes del flujo de trabajo para evitar el envío al servidor.
