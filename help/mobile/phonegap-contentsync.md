...
* **includeFolders** - Type es una matriz de cadenas y permite al usuario especificar carpetas adicionales para analizar en la biblioteca del cliente para recuperar archivos (como fuentes personalizadas).
