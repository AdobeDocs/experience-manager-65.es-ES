...
Si es necesario, puede anular esta secuencia de comandos para gestionar rutas más complejas, incluidas aquellas con variables. Un ejemplo de esto se puede ver en el script /apps/weretail-app/components/angular/ng-template-page/angular-route-fragment.js.jsp que se instala con AEM:
...
Como se describe en [Plantillas de página AEM](/help/mobile/apps-architecture.md), cada componente puede generar un fragmento de JavaScript para consumir el contenido JSON expuesto por la promesa `data`. Siguiendo las convenciones de Angular, un controlador solo debe utilizarse para asignar variables al ámbito.
...
Este directorio contiene los [enlaces CLI](https://gist.github.com/jlcarvalho/22402d013bc72f795d45a01836ce735c). Las carpetas del directorio hooks contienen scripts node.js que se ejecutan en puntos exactos durante la compilación.
...
Por convención, en AEM el nodo /etc contiene contenido clientlib estático. El directorio etc. contiene las bibliotecas Topcoat, AngularJS y We.Retail ng-clientlibsall.
