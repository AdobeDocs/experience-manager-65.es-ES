...
Complete los detalles de la nueva aplicación según sea necesario, incluido el cambio opcional de la imagen en miniatura. Estos valores se pueden editar más adelante desde el mosaico **Administrar aplicación**.
