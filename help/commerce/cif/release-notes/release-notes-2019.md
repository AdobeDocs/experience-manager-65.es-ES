---
title: Notas de la versión de contenido y comercio de AEM de 2019
description: Notas de la versión de contenido y comercio de AEM de 2019
...
* Cierre de compra y minicarro basados en React del lado del cliente usando GraphQL para admitir un recorrido de compra básico completo.
...
* El almacenamiento en caché de GraphQL está habilitado para ciertas consultas de GraphQL a través de GET HTTP para reducir el tiempo de respuesta.
