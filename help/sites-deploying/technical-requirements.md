...
| MongoDB Enterprise 5.0 | Repositorio | A: Compatible `[3, 4, 7]` |
...
| JBoss® EAP 7.4 con el servidor de aplicaciones JBoss® <sup>[2] [3] | A: Compatible |
...
1. Linux® Kernel 2.6, 3. x, 4. x, 5. x, 6. x y 9. x incluye derivados de la distribución Red Hat®, incluidos Red Hat® Enterprise Linux®, Oracle Linux® y Amazon Linux®. Las funciones de complemento de AEM Forms solo son compatibles con Red Hat® Enterprise Linux® 8 y Red Hat® Enterprise Linux® 9.
...
* Red Hat® Enterprise 8 y versiones posteriores con las últimas correcciones
