...
La lista de cambios y correcciones para la versión más reciente se encuentra en la [Notas de la versión CRX2Oak](https://experienceleague.adobe.com/docs/experience-manager-64/release-notes/crx2oak.html).
