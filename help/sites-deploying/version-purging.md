...
* el Administrador [de versiones](#version-manager)Se puede configurar para depurar versiones antiguas cuando se crean versiones nuevas.

* la herramienta [Purgar versiones](/help/sites-deploying/monitoring-and-maintaining.md#purgeversionstool) Se utiliza como parte de la supervisión y el mantenimiento del repositorio.
...
Una versión solo se crea si la activación se produce en una ruta incluida en `versionmanager.ivPaths` (véase más adelante).
