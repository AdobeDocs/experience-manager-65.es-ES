...
>[!NOTE]
>
>Al mismo tiempo que se utiliza el enfoque de búsqueda integrada de Solr, se permite descargar la indexación en un servidor Solr. Si las funciones más avanzadas del servidor Solr se utilizan mediante un enfoque basado en rastreador, se requiere un trabajo de configuración adicional.
