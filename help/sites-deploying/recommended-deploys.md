...
Los microkernels actúan como gestores de persistencia a partir de AEM 6.2. La elección de una para adaptarse a sus necesidades depende del propósito de su instancia y del tipo de implementación que esté considerando.
...
Para los sitios que planeen implementar comunidades [](/help/communities/overview.md)AEM, se recomienda [elegir una implementación](/help/communities/working-with-srp.md#characteristicsofstorageoptions) optimizada para gestionar UGC anunciada por miembros de la comunidad desde el entorno de publicación.
