...
**2. Procesamiento de recursos** Un problema de procesamiento de recursos se produce cuando los usuarios cargan recursos y tardan minutos hasta que los recursos se convierten e incorporan fácilmente en Adobe Experience Manager AEM (DAM) ().
...
**Conexión de red con el usuario final** Una conexión de red lenta puede causar problemas de rendimiento y, en algunos casos excepcionales, también problemas de latencia. A veces, el usuario tiene una conexión lenta desde el ISP, especialmente en las intranets. Esto es un signo de topología de red incorrecta.

**Sistema de archivos temporal** Un sistema de archivos local lento puede causar problemas de rendimiento interactivo, especialmente al buscar, porque los índices de búsqueda se almacenan en el disco local. También puede causar problemas de procesamiento de recursos si se utiliza el proceso de línea de comandos.
...
* La latencia alta del disco se propaga a tiempos de acceso lentos para CRX y puede resultar en problemas de rendimiento interactivos.
