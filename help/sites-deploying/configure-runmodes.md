...
Se puede activar un modo de ejecución personalizado utilizando la opción `-r` al iniciar el inicio rápido. AEM Por ejemplo, utilice el siguiente comando para iniciar una instancia de con el modo de ejecución establecido en dev. &quot;
...
AEM Se encuentra en el archivo de `war` de la y debe actualizarse antes de la implementación.

AEM Consulte [Instalación de un servidor de aplicaciones con un servidor de aplicaciones](/help/sites-deploying/application-server-install.md) para obtener más información.
