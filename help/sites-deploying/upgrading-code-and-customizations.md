...
Las configuraciones de ContextHub se ven afectadas por una actualización. Las instrucciones sobre cómo recuperar las configuraciones existentes de ContextHub se pueden encontrar [aquí](/help/sites-developing/ch-configuring.md#recovering-contexthub-configurations-after-upgrading).
