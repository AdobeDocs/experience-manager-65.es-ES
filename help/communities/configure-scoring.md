...
1. A un usuario se le asigna un distintivo de moderador mediante cURL :
   ...
   Como un usuario ha ganado dos insignias de bronce y se le ha concedido una insignia de moderador, así es como aparece el usuario con su entrada al foro.
