...
Si la variable [bibliotecas requeridas del lado del cliente](/help/communities/essentials-forum.md#essentials-for-client-side) están incluidos, así es como se `Forum` el componente aparecerá:
