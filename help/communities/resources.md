...
* **[!UICONTROL Nombre del sitio]**
   ...
   (*Solo lectura*) El sitio de la comunidad al que se está agregando el recurso.
...
* En la consola **[!UICONTROL Resources]**, seleccione el sitio de comunidad que contiene el recurso.
