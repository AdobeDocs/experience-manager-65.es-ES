...
Si se crea un foro sobre CQ 5.4 y se publican temas, y luego el sitio se actualiza a AEM 5.6.1 o posterior, intentar ver las publicaciones existentes puede provocar un error en la página:
...
La actualización de AEM 5.6.1 a la última versión cq-socialcommunities-pkg-1.4.x o a AEM 6.0 provoca errores en el archivo de registro. Esto ocurre durante el inicio de una condición que se resuelve a sí misma como lo demuestra el error que no se ve al reiniciar.
