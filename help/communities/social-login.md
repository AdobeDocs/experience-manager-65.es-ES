...
1. **Crear** una aplicación social y un servicio en la nube.
   ...
   * Para admitir el inicio de sesión con el Twitter:
      ...
      * Creación y publicación de un [Servicio en la nube de Twitter Connect](#create-a-twitter-connect-cloud-service).
...
1. **Campos** (parámetros) especifica los datos reales solicitados mediante parámetros de URL.
   ...
   * Estos campos se especifican en [Proveedor OAuth de AEM Communities Facebook](#aem-communities-facebook-oauth-provider) y [Proveedor de OAuth de Twitter de AEM Communities](#aem-communities-twitter-oauth-provider).
...
1. En la navegación global, seleccione **[!UICONTROL Herramientas]** > **[!UICONTROL Cloud Service]** > **[!UICONTROL Configuración del inicio de sesión social de facebook]**.
...
1. **Crear/editar** Configuración del servicio de nube facebook.
   ...
   * **[!UICONTROL Título]** (*Requerido*) Escriba un título que identifique la aplicación de Facebook. Utilice el mismo nombre introducido que el *Nombre para mostrar* para la aplicación de Facebook.
...
1. En la navegación global, seleccione **[!UICONTROL Herramientas]** > **[!UICONTROL Cloud Service]** > **[!UICONTROL Configuración del inicio de sesión social de twitter]**.
...
* Seleccione una de las opciones **[!UICONTROL Iniciar sesión con Facebook]** o **[!UICONTROL Iniciar sesión con el Twitter]**.
...
* Seleccionar **[!UICONTROL Perfil]**: la página Perfil muestra la imagen de avatar del usuario, su nombre y apellidos. También muestra la información del perfil de Facebook o de Twitter según los campos o parámetros permitidos.
