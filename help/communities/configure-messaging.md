...
La función de mensajería ofrece la capacidad de:
...
* **Responder/Ver como medio**
   ...
   Si se selecciona, la URL de respuesta y la URL de visualización harán referencia a un recurso; de lo contrario, los datos se pasan como parámetros de consulta en la URL.
...
* **Botón Eliminar**
   ...
   Si se selecciona, muestra un `Delete` que permite marcar un mensaje como leído. Duplicará la funcionalidad de eliminación si **`Message Options`** también está marcada.

* **Opciones de mensaje**

   Si se selecciona, se muestra **`Reply`**, **`Reply All`**, **`Forward`** y **`Delete`** botones que permiten reenviar o eliminar un mensaje. Duplicará la funcionalidad de eliminación si **`Delete Button`** también está marcada.
...
* **Mostrar usuario**
   ...
   Elija una de estas opciones **`Sender`** o **`Recipients`** para determinar si se debe mostrar el remitente o los destinatarios.
...
* Entrada `Preview` modo, seleccione la **Mensajes** para abrir la página principal de mensajería. A continuación, seleccione el botón Nuevo mensaje para abrir `Compose Message` página.
...
* **Etiqueta del asunto**
   ...
   Introduzca el texto que se mostrará junto al `Subject` field. El valor predeterminado es `Subject`.
...
* **Etiqueta de archivo adjunto**
   ...
   Introduzca el texto que se mostrará junto al `Attachment` field. El valor predeterminado es **`Attach File`**.
...
* **Etiqueta de contenido**
   ...
   Introduzca el texto que se mostrará junto al `Content` field. El valor predeterminado es **`Body`**.
