...
* Instale las [actualizaciones más recientes de AEM 6.5](#aem64updates).
...
De forma predeterminada, la configuración de OSGi `AEM Communities Publisher Configuration` está configurada con la casilla de verificación **`Primary Publisher`** activada, de modo que todas las instancias de publicación de un conjunto de servidores de publicación se identifican como principales.
...
por ejemplo,
   ...
   * Es necesario [actualizar el paquete Granite Crypto](#refresh-the-granite-crypto-bundle) si la instancia de destinatario AEM se está ejecutando.
