...
Por ejemplo, desde el sitio de la comunidad, los administradores pueden ver varios informes relativos a la reproducción del vídeo.
...
La variable `Marketing Cloud Org Id` podrá introducirse en el momento de [creación de sitios de comunidad](/help/communities/sites-console.md) o más tarde [modificar](/help/communities/sites-console.md#modifying-site-properties) las propiedades del sitio de la comunidad.
...
Por ejemplo, introduzca *Análisis de la comunidad*
...
* **Título**
   ...
   (Obligatorio) Un título que se muestra para el marco. Por ejemplo, introduzca *Marco comunitario*.
