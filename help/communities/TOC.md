...
+ Administración {#administer}
   ...
   + [Características de configuración de Analytics para comunidades](analytics.md)
...
+ Creación {#authoring}
   ...
   + [Función de flujos de actividad](activities.md)
   + [Función Blog](blog-feature.md)
   + [Característica de calendario](calendar.md)
