...
En la IU clásica, no es posible trabajar con Dynamic Media. Consulte [Trabajar con Dynamic Media,](/help/assets/dynamic-media.md) que cubre la interfaz de usuario táctil.
