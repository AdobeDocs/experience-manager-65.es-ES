...
* Imágenes de fondo:
   ...
   Estos se consiguen utilizando hojas de estilo en cascada (CSS) en lugar de en HTML. Esto quiere decir que no se puede especificar un valor de texto alternativo. Por lo tanto, las imágenes de fondo no deben proporcionar información textual importante: si lo hacen, esta información también debe proporcionarse en el texto de la página.
