...
* Si su sitio web no está en el Experience Manager, consulte [Entregar recursos de Dynamic Media](/help/assets/delivering-dynamic-media-assets.md) en la interfaz de usuario táctil.
