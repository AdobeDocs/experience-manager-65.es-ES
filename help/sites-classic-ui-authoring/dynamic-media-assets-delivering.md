...
* Si el sitio web no está en Experience Manager, consulte [Enviar recursos de Dynamic Media](/help/assets/delivering-dynamic-media-assets.md) en la interfaz de usuario táctil.
