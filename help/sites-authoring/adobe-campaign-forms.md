...
1. Arrastre el componente **Clave principal cifrada** Vaya al formulario (en cualquier lugar) y toque o haga clic en **Configuración** icono. En la ficha **Adobe Campaign**, especifique un nombre para el parámetro de URL. Haga clic o pulse la marca de verificación para guardar los cambios.
...
1. Haga clic en el icono de configuración para abrir el componente. Por ejemplo, en **Campo de texto (Campaign)** componente, cambie el título y el texto.
