...
1. Utilice el menú desplegable **Marca** para seleccionar la marca para la que desea crear la actividad.
   ...
   >[!NOTE]
   >
   >El Adobe recomienda [crear marcas a través de la consola de actividades](/help/sites-authoring/activitylib.md#creating-a-brand-using-the-activities-console).
   >
   >
...
1. En el menú desplegable del motor de **Orientación**, seleccione el motor de orientación.
   ...
   * AEM Si está usando la integración de Adobe Campaign y de la aplicación de correo electrónico y está enviando contenido de destino (boletines), seleccione **Adobe Campaign**. Consulte [Integración con Adobe Campaign](/help/sites-administering/campaign.md) para obtener más información.
...
Seleccione **Adobe Campaign** como motor si integra AEM con Adobe Campaign. AEM Consulte [Integración de con Adobe Campaign](/help/sites-administering/campaign.md) para obtener más información.
