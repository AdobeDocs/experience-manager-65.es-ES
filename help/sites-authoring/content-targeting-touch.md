...
Cuando se añade una actividad de, también aparece en el [Consola Actividades](/help/sites-authoring/activitylib.md).
...
1. Utilice el **Marca** menú desplegable para seleccionar la marca para la que desea crear la actividad.
   ...
   >[!NOTE]
   >
   >Se recomienda lo siguiente [crear marcas a través de la consola actividades](/help/sites-authoring/activitylib.md#creating-a-brand-using-the-activities-console).
   >
   >
...
1. [Orientar](#diagramtargetconfiguringtheaudiences): especifique el público al que se orienta cada experiencia. Puede dirigirse a una audiencia específica y, si utiliza las pruebas A/B, decidir qué porcentaje del tráfico se destina a cada experiencia.
...
Realice el siguiente procedimiento después de [inicio del proceso de direccionamiento](/help/sites-authoring/content-targeting-touch.md#the-targeting-process-create-target-and-goals-settings).
...
1. Cree la oferta:
   ...
   * Para las experiencias no predeterminadas, puede: [añadir una oferta personalizada](#adding-a-custom-offer) o [añadir una oferta de la biblioteca](/help/sites-authoring/content-targeting-touch.md#adding-an-offer-from-an-offer-library).
...
Añada una oferta personalizada a la [biblioteca de ofertas](/help/sites-authoring/offerlib.md) cuando desee volver a utilizarla como la oferta para experiencias múltiples. Puede añadir ofertas a la biblioteca de la marca actual a la que está dirigiendo.
...
* El [Actividades que están activadas](/help/sites-authoring/activitylib.md).
* El [reglas que definen los segmentos](/help/sites-administering/campaign-segmentation.md).
* El contenido de las experiencias en los componentes de Target.
* El [configuración del motor de Orientación](/help/sites-authoring/activitylib.md).
...
Seleccione **Adobe Campaign** como motor si integra AEM con Adobe Campaign. Consulte [AEM Integración de los usuarios de con Adobe Campaign](/help/sites-administering/campaign.md) para obtener más información.
