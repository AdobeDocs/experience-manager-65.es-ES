...
> 
>Para versiones anteriores, puede registrar un Sling Servlet usted mismo para escuchar una llamada `sitemap.xml`. Utilice el recurso proporcionado mediante la API de servlet para buscar la página actual y sus descendientes y así generar un archivo `sitemap.xml`.
