...
<table>
  ...
  <tr>
    ...
    <td>
    <ul>
    <li>(GRANITE-63681) Los conectores del modelo de datos de formulario pueden no autenticarse porque las palabras clave y el patrón regex necesarios no están permitidos de forma predeterminada.</li>
    </ul>
    </td>
  </tr>
    <tr>
