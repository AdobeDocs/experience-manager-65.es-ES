...
* Si un administrador configura [!DNL Experience Manager Assets] 6.5.4 con Brand Portal a través de la consola de Adobe Developer, la variable [!DNL Brand Portal] El usuario no puede publicar el recurso de una carpeta de contribución desde [!DNL Brand Portal] a [!DNL Experience Manager] (NPR-33046).
