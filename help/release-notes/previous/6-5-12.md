...
Las principales funciones y mejoras introducidas en [!DNL Adobe Experience Manager] 6.5.12.0 son las siguientes:
...
* La publicación de nodos de usuario del entorno de Autor a Publish no funciona (NPR-38005).
...
* Al reprocesar los recursos de vídeo, se cancela la publicación de AVS (conjunto de vídeos adaptable) y representaciones de vídeo del servidor de Publish (CQ-4335461).
...
Para obtener información sobre actualizaciones de seguridad, consulte [[!DNL Experience Manager] página de boletines de seguridad](https://helpx.adobe.com/security/products/experience-manager.html).
...
>[!NOTE]
>
>El Adobe no recomienda quitar ni desinstalar el paquete [!DNL Adobe Experience Manager] 6.5.12.0.
...
* Ver [cómo comunicarse con Atención al cliente de Adobe](https://experienceleague.adobe.com/docs/customer-one/using/home.html).
