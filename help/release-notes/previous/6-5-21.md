...
* Elimine el código y la dependencia de la Search&amp;Promote AEM de Adobe de la versión 6.5 de, que llegó al final de su vida útil el [septiembre de 2022, según aviso](https://experienceleague.adobe.com/es/docs/discontinued/using/search-promote). (NPR-41855)
