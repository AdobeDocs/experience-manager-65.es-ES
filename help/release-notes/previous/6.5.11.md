...
* Al instalar AEM 6.5 Service Pack 11, es posible que experimente problemas con la funcionalidad de búsqueda de Assets (Imágenes). Si es así, se recomienda actualizar a la versión 6.5.12.0 e instalar la corrección adecuada.
