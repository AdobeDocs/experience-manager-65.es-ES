...
* Cuando el usuario intenta convertir formularios XDP de formularios PDF a HTML5. Algunos problemas que se producen durante el procesamiento de los formularios HTML5 para las fuentes camboyanas son:
   ...
   * Aparecen espacios adicionales al procesar la representación de formularios de HTML5. (CQ-4322509)
...
* Cuando el usuario intenta convertir formularios XDP de formularios PDF a HTML5, algunos de los problemas corregidos son:
   * Soporte para Farsi para renderizar como LTR.
   * Compatibilidad con RTL cuando se combina con texto LTR.
   * Compatibilidad con la rotación de imágenes.
   * Se añade el soporte para el idioma camboyano. Para habilitar la compatibilidad con Combodian, debe habilitar el indicador como `CTL=true` mientras se procesa el formulario de HTML5.
