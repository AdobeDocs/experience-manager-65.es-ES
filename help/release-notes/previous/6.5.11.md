...
* Entrada [!DNL Dynamic Media], en la interfaz para crear un nuevo perfil de codificación de vídeo, la variable [!UICONTROL Smart Crop Ratio] está etiquetada para la accesibilidad, de modo que los lectores de pantalla la anuncien adecuadamente.
...
* En el caso del flujo de trabajo de contenedor incrustado, se obtienen varios correos electrónicos de finalización de flujo de trabajo incluso después de seleccionar el `Notify on Complete of Container Workflow` opción (NPR-37280).
...
* [Experience Manager Screens: Feature Pack 202109](https://experienceleague.adobe.com/docs/experience-manager-screens/user-guide/release-notes/release-notes-fp-202109.html?lang=es)
