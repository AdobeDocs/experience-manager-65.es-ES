...
* **Compatibilidad con Camera Raw**: Hay disponible un nuevo paquete [!DNL Camera Raw] que admite [!DNL Adobe Camera Raw] v10.4. Ver [procesar imágenes mediante [!DNL Camera Raw]](/help/assets/camera-raw.md).
...
* Las páginas web no se pueden procesar cuando sus vínculos se modifican mediante paquetes de filtros de servlet personalizados, etc. (NPR-36857) <!-- Note updated as per CQDOC-19203, April 07, 2022 -->
...
* Los lectores de pantalla ahora narran de forma correcta el nombre, la función y el estado de varios segmentos en la cronología del vídeo al navegar con la tecla de flecha abajo en la página [!UICONTROL Crear vídeo interactivo] (CQ-4290706).
...
* El contraste de los números (tiempo en segundos) de la escala de la cronología de la página [!UICONTROL Crear vídeo interactivo] ahora cumple la proporción de luminosidad mínima necesaria para que los usuarios con percepción limitada del color puedan leerlos con facilidad (CQ-4290699).
