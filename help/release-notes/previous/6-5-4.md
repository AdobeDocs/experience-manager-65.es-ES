...
* Cuando la dirección URL de una página de Adobe Experience Manager Sites contiene dos puntos (`:`) o símbolo de porcentaje (`%`), el explorador deja de responder y el uso de la CPU aumenta (NPR-32369, NPR-31918).
...
* Generación de representación para recursos con ${extension} error (NPR-32294).
