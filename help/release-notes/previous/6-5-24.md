...
* En una implementación con MongoDB y varias instancias, instale [!DNL Experience Manager] 6.5.24.0 en una de las instancias de autor mediante el administrador de paquetes.<!-- UPDATE FOR EACH NEW RELEASE -->
