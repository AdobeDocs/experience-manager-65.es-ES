...
* Contraste bajo corregido en el mensaje de estado de bloqueo que se muestra en la página Flujo de trabajo Bloquear/Desbloquear. El mensaje ahora cumple una relación 4.5:1, lo que mejora la legibilidad y el cumplimiento de la ADA para los autores. (SITES-27270)
...
* Adobe ha aumentado el contraste de color para el texto Referencias de la página de inicio de Sites. El texto ahora cumple con WCAG 2.1 AA con una relación de al menos 4.5:1 y se lee claramente en temas de luz y pantallas brillantes. (SITES-24755)
...
## Instalación de [!DNL Experience Manager] 6.5.24.0{#install}
...
## Paquetes de contenido y paquetes OSGi incluidos {#osgi-bundles-content-packages}
...
* [Paquetes OSGi](/help/release-notes/assets/65240-bundles.zip)
* [Paquetes de contenido](/help/release-notes/assets/65240-packages.zip)
