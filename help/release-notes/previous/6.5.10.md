...
* [Actualizaciones de plataforma](/help/forms/using/aem-forms-jee-supported-platforms.md): [!DNL Adobe Experience Manager Forms] en JEE ha agregado compatibilidad con las siguientes plataformas:
