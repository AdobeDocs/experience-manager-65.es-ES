...
* Inquilino múltiple: los inquilinos que guardan propiedades de carpeta observan un mensaje de éxito y un mensaje de error que describe que la acción no se realizó correctamente: &quot;No se pueden editar las propiedades. Permisos insuficientes&quot;. Esto, por lo tanto, puede causar confusión. NPR-30545: revisión para CQ-4275333
...
* Configuración [!DNL Dynamic Media] Cloud Services en [!DNL Dynamic Media]-El modo híbrido genera varios grupos de informes vacíos creados en [!DNL Analytics]y sin id de grupo de informes almacenado en [!DNL Experience Manager], lo que provoca la duplicación de grupos de informes. Revisión para CQ-4249780
