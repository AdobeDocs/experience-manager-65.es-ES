...
* **[Mejoras de accesibilidad en AEM Forms Designer](https://helpx.adobe.com/content/dam/help/es/experience-manager/6-5/forms/pdf/using-designer.pdf)**: AEM Forms Designer presenta las siguientes mejoras de accesibilidad:

   * AEM Forms Designer ahora admite tablas de contenido accesibles mediante las nuevas etiquetas `<TOC>` y `<TOCI>`, lo que permite a los autores asignar estas funciones a los subformularios a través de la pestaña Accesibilidad. La función admite estructuras de TDC de varios niveles, entradas etiquetadas, referencias numeradas y subestructuras span, lo que permite a los lectores de pantalla identificar y navegar correctamente por el contenido de TDC.

   * AEM Forms Designer ahora admite la configuración de propiedades de accesibilidad para celdas de tabla, incluidos el ámbito, el intervalo de filas y el intervalo de columnas, lo que permite a los lectores de pantalla y a los dispositivos de asistencia interpretar correctamente la estructura de tabla en los PDF generados. Los autores pueden establecer estas propiedades directamente desde el cuadro de diálogo Propiedades de celda y verificarlas en la vista XML Source. Las propiedades configuradas se reflejan con precisión en la salida de PDF etiquetada y se pueden validar mediante el Editor de tablas de Acrobat.
...
* El orden de las etiquetas se cambia aleatoriamente en PDF, incluso si el etiquetado de Forms Designer es correcto. (LC-3921313) 
...
1. El paquete OSGi `org.apache.jackrabbit.oak-core` es de la versión 1.22.17 o posterior (utilice la consola web: `/system/console/bundles`).
