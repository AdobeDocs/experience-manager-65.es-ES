...
* El procesamiento del PDF falla con un mensaje de error `NoClassDefFoundError`. (NPR-38741)
...
* El Experience Manager no identifica la lista desplegable **[!UICONTROL Seleccionar un modelo de flujo de trabajo]** como un campo obligatorio al crear un modelo de flujo de trabajo. (ASSETS-6871)
...
* Habilitación de JavaScript ES6 (ECMAScript 6) para visores de Dynamic Media en el Experience Manager 6.5.14.0. (NPR-38393)
* Los usuarios que no son administradores no deben tener acceso a las opciones de configuración de Dynamic Media **[!UICONTROL Configuración general]** y **[!UICONTROL Configuración de Publish]**. (ASSETS-8628)
* La página de Dynamic Media **[!UICONTROL Configuración general]** no muestra correctamente los parámetros de carga ya configurados. (ASSETS-10245)
...
* Assets no se sube a la cuenta de Dynamic Media después de ejecutar el flujo de trabajo de Dynamic Media Reprocess Assets en recursos con un identificador de trabajo incorrecto. (ASSETS-12084, ASSETS-9877)
...
* Para los PDF forms estáticos creados con Forms 6.5 Designer, la accesibilidad del PDF falla con el error `Tab order entry in page with annotations not set to "S"`. (CQ-4343117)
* Se ha agregado la capacidad de especificar el texto del Reader de pantalla para los hipervínculos en Forms Designer.(NPR-36221)
...
* En Experience Manager, de **[!UICONTROL Operaciones]** > **[!UICONTROL Diagnóstico]**, experimenta un error al seleccionar **[!UICONTROL Descargar ZIP de estado]** > **[!UICONTROL Descargar]**. (NPR-38514)
...
* Al usar **[!UICONTROL Seleccionar todo]** > **[!UICONTROL Quick Publish]**, el Experience Manager no publicaba todos los recursos o mostraba cuántos se publicarían en la vista **[!UICONTROL Tarjeta]** o en la vista **[!UICONTROL Lista]**. (NPR-38546)
...
>[!IMPORTANT]
>
>El Adobe no recomienda quitar ni desinstalar el paquete [!DNL Experience Manager] 6.5.14.0. Por lo tanto, antes de instalar el Service Pack, debe crear una copia de seguridad de `crx-repository` en caso de que necesite revertirla. <!-- UPDATE FOR EACH NEW RELEASE -->
...
* [Lista de paquetes OSGi incluidos en el Experience Manager 6.5.14.0](/help/release-notes/assets/65140_bundles.txt) <!-- UPDATE FOR EACH NEW RELEASE -->
* [Lista de paquetes de contenido incluidos en el Experience Manager 6.5.14.0](/help/release-notes/assets/65140_packages.txt) <!-- UPDATE FOR EACH NEW RELEASE -->
