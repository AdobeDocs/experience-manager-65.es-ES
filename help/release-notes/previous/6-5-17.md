...
* **Flujo DASH con Dynamic Media**: Se ha lanzado la compatibilidad con el nuevo protocolo (DASH - Flujo adaptable dinámico a través de HTTP) para el flujo adaptable en la entrega de vídeo de Dynamic Media (con CMAF habilitado).
