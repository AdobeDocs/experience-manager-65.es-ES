...
* En una implementación con MongoDB y varias instancias, instale [!DNL Experience Manager] 6.5.23.0 en una de las instancias de autor mediante el administrador de paquetes.<!-- UPDATE FOR EACH NEW RELEASE -->
...
UberJar para [!DNL Experience Manager] 6.5.23.0 está disponible en el [repositorio de Maven Central](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.23/). <!-- CHECK FOR UPDATE EACH NEW RELEASE -->
...
* **FORMS-16575**: ninguna modificación al XDP de los fragmentos de diseño anidados en una comunicación interactiva se reflejará en el editor de CI.
...
* **FORMS-15681**:When la carta se verá en la vista preliminar y el contenido cambiará. Es decir, algunos espacios desaparecen y ciertas letras se reemplazan por `x`.
...
* [Lista de paquetes OSGi incluidos en Experience Manager 6.5.23.0](/help/release-notes/assets/65230-bundles.zip)
<!-- UPDATE FOR EACH NEW RELEASE -->
* [Lista de paquetes de contenido incluidos en Experience Manager 6.5.23.0](/help/release-notes/assets/65230-packages.zip)
<!-- UPDATE FOR EACH NEW RELEASE -->
