...
El nuevo protocolo DASH (Dynamic Adaptive Streaming over HTTP) admite el inicio de la transmisión de velocidad de bits adaptable en la entrega de vídeo de Dynamic Media (con CMAF [Formato de aplicación de medios comunes] habilitado).
