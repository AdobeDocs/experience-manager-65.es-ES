...
* En caso de que cambie la contraseña predeterminada del usuario administrador de `admin`, mientras se realiza la `Prepare Adobe Experience Manager Server For DSC deployment` compruebe en el Service Pack de AEM Forms JEE si se produce un error. (NPR-40062) y (NPR-39387)
