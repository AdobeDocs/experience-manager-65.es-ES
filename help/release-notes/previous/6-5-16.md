...
* XMP La propiedad `dam:size` no se actualiza después de la reescritura de la aplicación, lo que hace que se devuelva información incorrecta desde la API `/platform/path/to/asset.jpg;resource=metadata`. (ASSETS-17631)
...
* AEM Cuando actualiza a la versión 6.5.14.0 de la versión y utiliza el servicio importData para combinar PDF con XML, se produce el siguiente error: `Caused by: java.lang.NoSuchMethodError: com.adobe.xfa.form.FormModel.isXFABarcode(Lcom/adobe/xfa/Node;)Ljava/lang/Boolean`. (NPR-39807)
...
* AEM Después de que un usuario actualice a Paquete de servicio de 6.5.15.0, la conversión de PostScript a Pdf no funciona. (NPR-39765) y (NPR-39764)
...
AEM Después de instalar el paquete de servicio de complemento de Forms de 6.5.16.0 de, los clientes se enfrentaban a los siguientes problemas. AEM Por lo tanto, se ha lanzado una versión actualizada del paquete de servicio de complementos de Forms [6.5.16.0 - 6.0.914](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html?lang=es). El Adobe recomienda utilizar el Service Pack actualizado:
...
* Elimine el código de Search&amp;Promote de Adobe y la dependencia de Experience Manager 6.5. El Search&amp;Promote de Adobe llegó al fin de servicio en septiembre de 2022. Ver [Anuncio de fin de servicio de Search&amp;Promote de Adobe](https://experienceleague.adobe.com/docs/discontinued/using/search-promote.html). (NPR-39706)
...
>[!IMPORTANT]
>
> El Adobe no recomienda quitar ni desinstalar el paquete [!DNL Experience Manager] 6.5.16.0. Como tal, antes de instalar el paquete, debe crear una copia de seguridad de `crx-repository` en caso de que tenga que revertirla. <!-- UPDATE FOR EACH NEW RELEASE -->
...
Los clientes que usan GraphQL AEM deben instalar el [fragmento de contenido con el paquete de índice 1.0.5](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=%2Fcontent%2Fsoftware-distribution%2Fen%2Fdetails.html%2Fcontent%2Fdam%2Faem%2Fpublic%2Fadobe%2Fpackages%2Fcq650%2Ffeaturepack%2Fcfm-graphql-index-def-1.0.5.zip) de GraphQL.
...
* AEM En la plataforma JBoss® 7.1.4, cuando un usuario instala el paquete de servicio 6.5.16.0 de la aplicación, se produce un error en la implementación de `adobe-livecycle-jboss.ear`.
...
* [Lista de paquetes OSGi incluidos en el Experience Manager 6.5.16.0](/help/release-notes/assets/65160_bundles.txt) <!-- UPDATE FOR EACH NEW RELEASE -->
* [Lista de paquetes de contenido incluidos en el Experience Manager 6.5.16.0](/help/release-notes/assets/65160_packages.txt) <!-- UPDATE FOR EACH NEW RELEASE -->
