...
* En AEM Forms Designer instalado mediante Workbench, la información de la versión no es explícita en la variable `Control Panel/Programs/Programs and Features`. (LC-3921976)
