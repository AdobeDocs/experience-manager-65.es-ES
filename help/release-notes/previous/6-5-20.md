...
* Cuando se utiliza la Publicación rápida de un fragmento de contenido, continúa cargándose y no se publica. Es decir, Publicación rápida no funciona para fragmentos de contenido después de una actualización de Service Pack de AEM 6.5.7 a AEM 6.5.17. Cuando el usuario intentó la publicación administrada, funcionó. Sin embargo, con Publicación rápida, no se publicaba. En concreto, `com.day.cq.wcm.core.impl.reference.ActivationReferenceSearchBuilder` provocó que el sistema se saturara. (SITES-17311)
...
* [!DNL Experience Manager] 6.5.20.0 requiere [!DNL Experience Manager] 6.5. Consulte [documentación de actualización](/help/sites-deploying/upgrade.md) para obtener instrucciones detalladas. <!-- UPDATE FOR EACH NEW RELEASE -->
...
>[!IMPORTANT]
>
> Adobe no recomienda quitar ni desinstalar el paquete [!DNL Experience Manager] 6.5.20.0. Como tal, antes de instalar el paquete, debe crear una copia de seguridad de `crx-repository` en caso de que deba revertirla. <!-- UPDATE FOR EACH NEW RELEASE -->
...
* [Lista de paquetes OSGi incluidos en Experience Manager 6.5.20.0](/help/release-notes/assets/65200-bundles.zip) <!-- UPDATE FOR EACH NEW RELEASE -->
* [Lista de paquetes de contenido incluidos en Experience Manager 6.5.20.0](/help/release-notes/assets/65200-packages.zip) <!-- UPDATE FOR EACH NEW RELEASE -->
