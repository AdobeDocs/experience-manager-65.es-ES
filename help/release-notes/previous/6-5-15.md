...
* En AEM Designer, los campos de formulario sin subtítulos se colocan en celdas de tabla, incluidas las casillas de verificación. (LC-3920410)
...
* Ordenar los títulos en la vista de lista, tanto en orden ascendente como descendente, muestra cómo se ordenan los títulos con el orden A, C, B. (SITES-7585)
