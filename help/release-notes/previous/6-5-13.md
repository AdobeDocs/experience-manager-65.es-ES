...
[!DNL Experience Manager] 6.5.13.0 incluye nuevas funciones, mejoras clave solicitadas por el cliente y otras de rendimiento, estabilidad y seguridad, que se han publicado desde la publicación inicial de 6.5 en abril de 2019. [Instalar este Service Pack](#install) en [!DNL Experience Manager] 6.5.

Las principales funciones y mejoras introducidas en [!DNL Adobe Experience Manager] 6.5.13.0 son las siguientes:
...
En [!DNL Experience Manager] 6.5.13.0 se introdujeron las siguientes correcciones de errores, funciones clave y mejoras:
...
* Al abrir una colección inteligente que se guarda con el filtro de búsqueda aplicado como Publish, el filtro de búsqueda cambia automáticamente a No publicado. (CQ-4341191)
...
* No se puede acceder a Quick Publish de un producto desde la página de resultados de búsqueda después de cambiar las propiedades. (CQ-4343318)
...
* La codificación de código de barras PDF 417 producida por [!DNL Experience Manager] Forms no es válida para un grupo de botones de opción. (NPR-38525)
...
* Se cerró la sesión de los usuarios de [!DNL Experience Manager] instancias de Publish de forma aleatoria y no se pudo enviar un formulario adaptable. El problema aparece en [!DNL Experience Manager] instancias que utilizan Dispatcher. (NPR-38285)
...
* Al invocar un método de servicio de extremo de AEM Forms JEE service, en un botón que se configura como regla de formulario adaptable, se produce un error en el servicio de punto final de SOAP SOAP, con la siguiente excepción:
...
* SPA A partir de la versión 6.5.13 de, ya no debe crear el nodo de componente contenedor en JCR antes de realizar ediciones mediante el Editor de componentes (Editor de componentes). Se crea un `virtual container` antes de guardarlo mediante el SDK. (SITES-5762)
...
* Actualizar a `favicon.ico` que se usa en el Experience Manager. (CQ-4315324)
...
>[!NOTE]
>
>El Adobe no recomienda quitar ni desinstalar el paquete [!DNL Experience Manager] 6.5.13.0.
...
* AEM [Fragmento de contenido de con el paquete de índice 1.0.3](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=%2Fcontent%2Fsoftware-distribution%2Fen%2Fdetails.html%2Fcontent%2Fdam%2Faem%2Fpublic%2Fadobe%2Fpackages%2Fcq650%2Ffeaturepack%2Fcfm-graphql-index-def-1.0.3.zip) de GraphQL
