...
* Disponible ahora en Norteamérica (para habilitar mediante ticket de asistencia), próximamente en Asia-Pacífico y Europa-Oriente Medio-África.
...
* Al utilizar un paso Asignar tarea** para enviar una notificación para una tarea asignada, se envían dos correos electrónicos en lugar de uno a la persona asignada. (NPR-40078)
...
Estos sitios web solo están disponibles para los clientes de. Si es un cliente y necesita obtener acceso, póngase en contacto con su administrador de cuentas de Adobe.
