...
* **Compatibilidad para pasar XCI personalizados:** Se agregó compatibilidad para pasar XCI personalizados en parámetros de la aplicación de cmdline xmlformcmd. Esta funcionalidad permite a los usuarios especificar archivos XCI personalizados para probarlos, mejorar la flexibilidad y el control sobre el proceso de prueba. (LC-3923248)
...
* Los lectores de pantalla reciben un mensaje hablado `Loading` mientras se actualiza la vista Sitios. La actualización añade una región activa de estado dedicada y escribe el mensaje en ella mediante programación, lo que confirma el progreso sin desplazar el enfoque. (SITES-24481)
* El carril lateral Activos ahora incluye un control **Cerrar** transparente y devuelve el enfoque al botón de alternar. Los usuarios con teclado y lector de pantalla descartan el panel inmediatamente en lugar de desplazarse por cada control. El cambio reduce las pulsaciones de tecla y coincide con el comportamiento esperado del panel. (SITES-24489)
* La lista de pestañas ARIA del Editor de páginas de sitios incluye un nombre descriptivo. Los lectores de pantalla ahora identifican el control como una lista de pestañas y leen la etiqueta correcta, lo que permite a los usuarios encontrar el conjunto de pestañas adecuado y moverse entre ellas de manera fiable. (SITES-24492)
* La búsqueda en la barra lateral del Editor ahora anuncia los resultados a los lectores de pantalla. A medida que los usuarios escriben, un mensaje de estado activo informa de la cantidad de coincidencias y actualizaciones sin desplazar el foco. Los usuarios del teclado descubren los resultados inmediatamente. (SITES-24506)
...
* El encabezado pegajoso dejó de oscurecer el cuadro de diálogo modal teaser durante el uso de zoom alto. El contenido sigue siendo legible y utilizable a 200% y 400% de zoom, con flujo vertical y sin secciones recortadas. (SITES-24523)
...
* El campo Texto alternativo del cuadro de diálogo de hipervínculos del editor de texto ahora expone una etiqueta programática. Los lectores de pantalla anuncian `Alternative text` para el campo, y el enfoque aterriza en el control con nombre correcto. Esta corrección mejora la navegación para los usuarios de teclado y voz. (SITES-24675)
...
* El cuadro de diálogo Imagen ahora anuncia su estado de carga a través de una región en vivo de ARIA. Los lectores de pantalla escuchan un mensaje `Loading, please wait` mientras aparece el spinner. Y, una actualización lista cuando el contenido finaliza, para que los usuarios sepan cuándo pueden interactuar. (SITES-24697)
* El cuadro de diálogo Selección de vínculo ahora muestra una región activa que anuncia los resultados de la búsqueda. Los lectores de pantalla escuchan el estado `results updated` después de cada búsqueda sin desplazar el foco, de modo que los usuarios obtienen una confirmación clara de que la búsqueda se ha completado. (SITES-24700)
...
* Los filtros de cambio ahora informan de su estado como expandido o contraído. El botón conmuta `aria-expanded` en sincronización con el panel de filtro y expone un solo nombre no cifrado (`Change filters`), lo que elimina el confuso anuncio `filter?`. Los usuarios del lector de pantalla pueden predecir el resultado de activar el control. (SITES-24713)
...
* El estado de los resultados ahora anuncia a los lectores de pantalla cuando cambian los filtros. NVDA lee el recuento `X of Y results` y el mensaje `no results`. El estado de paginación utiliza una región activa que se actualiza in situ, de modo que los usuarios escuchan la confirmación sin desplazar el foco. (SITES-24720)
...
* Se quitó la función `presentation` que ocultaba la tabla de la página principal Sitios del árbol de accesibilidad. La tabla vuelve a leerse correctamente. NVDA y JAWS detectan la tabla, reconocen los encabezados y anuncian las relaciones de encabezado durante la navegación de filas y columnas. (SITES-24942)
* La ordenación de los comentarios en la vista de lista es explícita y coherente. Después de una ordenación, el encabezado expone el orden a través de `aria-sort`. Anuncia el cambio, mientras que los encabezados sin ordenar ya no reclaman un estado, lo que ayuda a los usuarios del lector de pantalla a realizar un seguimiento de qué columna controla la ordenación. (SITES-24943)
* El encabezado Editar diseño ya no muestra un botón **Editar** que no funciona. El control ahora actúa como una etiqueta de estado estática y permanece fuera del orden de tabulación, por lo que los usuarios del teclado no malgastan una pulsación de tecla. Use **Seleccionar otro modo** para cambiar de modo, con comentarios claros del lector de pantalla. (SITES-24950)
* La barra de herramientas del emulador muestra los nombres completos de los dispositivos de forma predeterminada. La etiqueta ya no se trunca durante la carga, por lo que los usuarios pueden leer y seleccionar dispositivos sin tener dudas. El texto se escala de forma nítida en los niveles de zoom y se reducen los anchos. (SITES-24952)
* La barra de herramientas del emulador se adapta a ventanillas pequeñas. A 320 píxeles, la lista de dispositivos y controla la pantalla sin recortar, de modo que los usuarios pueden seleccionar Galaxy S7 y modelos más nuevos. La disposición se ajusta y se ajusta para evitar el desplazamiento horizontal incluso con un zoom del 400%. (SITES-24953)
* Los lectores de pantalla anuncian el dispositivo seleccionado y sus medidas en el emulador. NVDA deja de leer la secuencia de reglas; el botón de dispositivo utiliza una descripción adjunta para el texto de la información sobre herramientas, lo que reduce el ruido y guía la navegación. (SITES-24955)
...
* Las actualizaciones de estado en la vista del filtro de administración de sitios se anuncian a los lectores de pantalla. Cuando los usuarios cambian de tarjeta o lista mientras se cargan los elementos, NVDA ahora transmite el mensaje `Please wait` a través de una región activa. Esta guía evita clics y confusiones adicionales. (SITES-24992)
* El enfoque del teclado ahora se mueve en un orden lógico cuando los usuarios expanden el carril izquierdo. El enfoque cambia directamente del botón del carril izquierdo al contenido expandido, lo que elimina la necesidad de volver atrás u omitir elementos. Este cambio mejora la accesibilidad para los lectores de pantalla y los usuarios de teclado. (SITES-24998)
...
* La acción de confirmación en el cuadro de diálogo Teaser se anuncia correctamente a los lectores de pantalla. Los informes de control `Confirm` no contienen la descripción del icono, lo que proporciona a los usuarios del teclado y del lector de pantalla una orientación clara. (SITES-25223)
* El botón Ayuda ahora muestra un nombre de acceso no cifrado. Los lectores de pantalla anuncian `Help` en lugar de una descripción detallada del icono. Los usuarios comprenden la acción y pueden encontrar asistencia más rápido. (SITES-25224)
...
* Los lectores de pantalla ahora anuncian los controles Anotar y Cerrar anotación con precisión en la barra de herramientas Anotación. NVDA ya no dice `Preview button pressed,`, lo que engañó a los autores y sugirió una acción incorrecta. El anuncio coincide con el botón presionado y mantiene el flujo de trabajo despejado. (SITES-25234)
...
* El cuadro de diálogo **Eliminar anotación** ahora controla correctamente el foco del teclado. Al abrir el cuadro de diálogo, el enfoque se desplaza a su encabezado para el contexto del lector de pantalla y al cerrarlo, el enfoque se devuelve al botón **Eliminar anotación** que lo inició. Los usuarios ya no aterrizan en controles no relacionados ni detrás del modal. (SITES-25258)
* El Selector de fecha de deformación de tiempo ahora administra el enfoque correctamente. Al presionar `Esc`, se devuelve el enfoque al botón **Selector de fecha** y al elegir una fecha, se mueve el enfoque al campo de entrada vinculado. Los usuarios con teclado y lector de pantalla mantienen el contexto y no aterrizan detrás del modo. (SITES-25264)
* Los lectores de pantalla anuncian las acciones correctas para los botones **Anotar** y **Cerrar anotación**. NVDA ya no dice `Preview button pressed`; anuncia el nombre del botón para que los usuarios sepan cuándo se inicia o termina el modo de anotación. (SITES-25268)
* El modo Anotación muestra ahora una acción **Enviar** clara. Los autores pueden agregar un comentario y enviarlo con el botón del icono del lápiz o descartar la ventana modal con `Esc`, sin adivinar el flujo. (SITES-25269)
* La entrada de anotación incluye botones de acción explícitos. El cuadro de diálogo muestra **Enviar** para guardar la nota y **Cancelar** para cerrarla, ambos accesibles mediante teclado y anunciados por tecnología de asistencia. Los autores ya no necesitan hacer clic fuera del cuadro de diálogo ni presionar solo `Esc` para finalizar. (SITES-25281)
...
* El selector de dispositivos de Editar diseño funciona según lo diseñado. Cuando dos opciones de dispositivo tienen anchuras similares (por ejemplo, iPhone 8 Plus junto a Galaxy 7), el botón seleccionado muestra información sobre herramientas para mostrar la etiqueta completa, mientras que ambos botones permanecen visibles y accesibles. (SITES-25285)
* Con un zoom del 200 %, Editar diseño ya no sobrescribe la página. La barra de herramientas representa completamente y expone el desplazamiento horizontal cuando es necesario, restaurando el acceso a los controles ocultos anteriormente para los usuarios con poca visión. (SITES-25288)
* El orden de tabulación en Vista previa del diseño ahora se mueve de la barra de herramientas principal directamente a la barra de herramientas Demográfica. Los usuarios de teclado y lector de pantalla pueden recorrer los controles en una secuencia predecible en lugar de saltar a la barra de herramientas secundaria. El cambio se alinea con el orden de enfoque de WCAG 2.4.3. (SITES-25305)
* Al ampliar la página al 200 %, ya no se oculta parte de la barra de herramientas Demográfica. La sección de la barra de herramientas administra el desbordamiento y proporciona desplazamiento en su propia región, manteniendo cada control visible y operable a una gran ampliación. (SITES-25309)
* Las entradas de texto en la barra de herramientas Demographic ahora exponen nombres accesibles adecuados. Cada campo incluye un ID único con una etiqueta programática, de modo que los lectores de pantalla anuncian el propósito del campo y los usuarios pueden navegar por ella. La etiqueta visible se sitúa cerca del control para mejorar la legibilidad de baja visión. (SITES-25316)
* El botón Editar ahora anuncia la acción correcta para filtrar los lectores en la barra de herramientas secundaria. Al activarlo se lee `Edit` en lugar de `Preview button pressed,` sin relación, lo que elimina la confusión durante la navegación mediante el teclado. (SITES-25320)
* El deslizador del carrito de la barra de herramientas Demografía ahora expone un nombre accesible adecuado. Los lectores de pantalla anuncian `Cart total` y las herramientas de entrada de voz pueden dirigir el control por nombre, mejorando el cumplimiento con WCAG 4.1.2 (Nombre, Función, Valor). (SITES-25322)
* El control deslizante de la barra de herramientas Demografía ahora mantiene el enfoque cuando los autores cambian el valor con las teclas de dirección. El foco ya no salta al botón Cart, por lo que los usuarios del teclado ajustan el valor continuamente y los lectores de pantalla anuncian cada cambio. (SITES-25324)
* Buscar activos ahora refluye limpiamente a 320 px (aproximadamente un 400%). El modal mantiene títulos, campos y acciones legibles y no superpuestas, de modo que los autores pueden buscar sin desplazamiento horizontal. (SITES-25330)
...
* AEM anuncia el estado de carga en el modal Teaser. El modal ahora expone un mensaje de estado activo mientras se carga el contenido, por lo que NVDA y JAWS hablan `Loading, please wait.` Los autores deben recibir comentarios claros y evitar interactuar con el cuadro de diálogo antes de que esté listo. (SITES-25366)
...
* Tratamiento de errores mejorado en los cuadros de diálogo de creación. Cuando se produce un error de configuración, la interfaz de usuario muestra texto explícito y activa un anuncio de lector de pantalla a través de una región de alerta. Los autores reciben comentarios inmediatos y pueden corregir el problema sin perder el contexto. (SITES-27155)
* Se ha corregido un defecto de accesibilidad de Reflow en el administrador de sitios. Con un zoom del explorador del 400 %, la barra de herramientas y la cuadrícula controlan las acciones de teclas superpuestas e insertadas fuera de la pantalla, lo que bloquea la navegación mediante el teclado y el uso del lector de pantalla. El diseño ahora se reajusta correctamente para que los botones de búsqueda, filtro y acción permanezcan visibles y operables con un zoom del 400 %. (SITES-27238)
...
* La navegación de encabezado oculto aceptó el enfoque y confundió a los usuarios videntes y a los lectores de pantalla. La actualización deshabilita el foco en los controles contraídos y expone sólo los elementos visibles. La navegación sigue siendo predecible y cumple con WCAG 2.4.3. (SITES-35224)

* Se han corregido los iconos de miniaturas de carpeta en el administrador de sitios para que se comporten como imágenes decorativas. La actualización elimina la función de imagen y aplica texto alternativo vacío, por lo que la tecnología de asistencia ignora los iconos y lee solo las etiquetas significativas. (SITES-2852)
* Adobe aumentó el contraste de color del texto Referencias de la página principal Sitios. El texto ahora cumple con WCAG 2.1 AA con una proporción de al menos 4.5:1 y se lee claramente en temas claros y pantallas brillantes. (SITES-24755)
* El hito del carril Referencias ahora anuncia su nombre a los lectores de pantalla. La región expone un `aria-label` único (`References rail`), que mejora la navegación de puntos de referencia y lo distingue de otras regiones. (SITES-24973)
* La descripción RTE bloqueó el flujo de navegación de tabulaciones hacia delante y de cuadros de diálogo rotos. La corrección restaura el movimiento de teclado estándar. Los autores continúan más allá del campo con una sola pestaña y mantienen el orden de selección predecible. (SITES-35228)
* Los controles de creación carecían de nombres accesibles y de texto de icono sin procesar expuesto, lo que confundía a JAWS. La corrección añade etiquetas ARIA explícitas y funciones estándar. Los anuncios suenan correctos y se alinean con las expectativas de accesibilidad. (SITES-35227)
* La lista desplegable Categorías carecía de una etiqueta específica, por lo que JAWS habló un `images button menu.` genérico. La actualización nombra el control `Categories` y define su función. Los usuarios de lectores de pantalla escuchan una etiqueta precisa y entienden las opciones disponibles. (SITES-35226)
* El cuadro de diálogo Propiedades mostraba una cuadrícula de datos que los lectores de pantalla consideraban texto sin formato. JAWS y NVDA perdieron el enfoque y no anunciaron filas y columnas. La corrección agrega semántica de tabla real y funciones ARIA. Los lectores de pantalla ahora reconocen correctamente la tabla y rastrean el enfoque. (SITES-35225)
...
* Los campos de formulario de tabulación básicos no pudieron mostrar un texto de error útil. El formulario ahora muestra mensajes en línea claros y los vincula al campo para lectores de pantalla. Los usuarios de teclado y tecnología de asistencia reciben una guía inmediata para corregir las entradas. (SITES-32480)
* El multicampo utilizado en un componente personalizado expone botones de icono sin etiquetar y un orden de tabulación incoherente. JAWS/NVDA solo anunció `button` o omitió los controles, lo que bloqueó la operación del teclado. La actualización proporciona nombres descriptivos para Agregar, Quitar y Mover, normaliza las tabulaciones y anuncia actualizaciones de la lista para satisfacer las expectativas de ADA. (SITES-30660)
...
* No se requiere ningún cambio. Adobe ha revisado la afirmación de que el icono de búsqueda se superpone con el texto cercano. El encabezado incluía una etiqueta agregada por el cliente; vanilla AEM representa sólo el icono. Una instancia limpia muestra el diseño correcto con un zoom del 100%, por lo que el error se cerró fuera del alcance. (SITES-26910)
...
Los usuarios del lector de pantalla no recibieron ayuda de navegación en la cuadrícula **Modelo del sistema de catálogo**. JAWS solo anunció la posición de la celda y luego se quedó en silencio. La versión agrega funciones y directrices accesibles, lo que permite a JAWS leer el contexto de la lista, el elemento seleccionado y los controles necesarios de flecha/espacio. (SITES-30661)
...
Los paréntesis en el nombre de un fragmento de contenido provocaban que el panel Referencias informara de un uso incorrecto. Los autores vieron 0 incluso cuando otros fragmentos hacían referencia a él. La corrección corrige el análisis de rutas de acceso para `(` y `)` y muestra el recuento y las entradas correctas que no son cero. (SITES-35078)


#### [!DNL Content Fragments]: editor de fragmentos{#sites-fragments-editor-6524}

* Error de cancelación de publicación para fragmentos de contenido cuya ruta DAM contenía paréntesis. El Asistente para administrar publicaciones reescribió `(` y `)`, y rompió la ruta de acceso del recurso. La corrección conserva los caracteres y resuelve el elemento correcto, por lo que la acción de cancelar la publicación finaliza. (SITES-35077)
* Al editar un fragmento de contenido y volver a la lista Activos , se ocultaba el fragmento o toda la carpeta. La lista no se actualizó después de cerrar el editor. La corrección ahora actualiza la lista de forma fiable y mantiene visible el fragmento editado sin necesidad de volver a cargarlo. (SITES-35374)
...
* Fragmentos de experiencia ahora localiza la advertencia que se muestra cuando no existe ninguna configuración de Adobe Target. El mensaje se muestra en la configuración regional del autor en lugar de en inglés, por lo que los pasos de exportación y activación se leen correctamente para equipos globales. (SITES-11868)
* La publicación de una variación de Fragmento de experiencia ahora muestra un mensaje de error localizado cuando ningún servicio en la nube se adjunta a la variación. El mensaje aparece en la interfaz de usuario en el idioma del usuario en lugar de una cadena que sólo está en inglés. (SITES-20293)
* Exportar un fragmento de experiencia a destino se bloqueó con `Attempt to modify attribute at illegal index: -1`. La instrumentación de constantes vitales web entraba en conflicto con el exportador y el control de atributos dañados. La corrección endurece el procesamiento de atributos y elimina ese conflicto. Las exportaciones se realizan correctamente y el fragmento se procesa en Target. (SITES-31891)

* Las propiedades del fragmento de experiencia ahora localizan la ficha **Referencias**. Las etiquetas y los encabezados de columna, como `Page,` `Page path,` y `Variation title`, se muestran en el idioma del autor. Este cambio elimina las cadenas de solo inglés y mantiene la coherencia de la vista de propiedades para los equipos globales. (SITES-11203)
...
* Al eliminar un Launch muy grande, se bloqueó el repositorio. El trabajo puso en cola demasiadas eliminaciones y privó de otras solicitudes. La corrección ahora elimina lotes y produce rendimientos entre fragmentos, por lo que la limpieza se completa mientras el sistema permanece receptivo. (SITES-32004)
...
* Las comprobaciones necesarias en la configuración de IMS se ejecutan al actualizar, no solo al crear. Los valores vacíos en campos como Id. de cliente o Secreto de cliente muestran un error y detienen el guardado hasta que se introduzca un valor válido, impidiendo la reutilización del valor anterior. (CQ-4359938)
* La creación del lanzamiento muestra la validación traducida y las cadenas de error. Ya no aparecen mensajes exclusivos en inglés para errores de creación y páginas de origen que faltan. Los autores ven una respuesta clara, correcta en la configuración regional durante la configuración de lanzamiento. (SITES-13085)
...
* Conmutación de modo interrumpido de AEM 6.5 SP23 en el editor de páginas. Al hacer clic en **Diseño**, **Desarrollador** o **Destino**, el editor se quedó atascado en el modo **Editar** y se inició una consola `TypeError`. La actualización restaura los cambios del modo de la barra de herramientas y borra el error. (SITES-34536)
* El Editor de páginas saltó desde el punto de inserción cuando los autores agregaron componentes en contenedores largos. La actualización ajusta la temporización de la superposición y el control de desplazamiento. La vista mantiene su lugar y el nuevo componente permanece a la vista y listo para configurarse. (SITES-32621)
* Error de etiquetas de etiqueta personalizadas en el Editor de páginas y la interfaz de usuario siempre muestra `Tags.`. El predicado ahora evalúa `fieldLabel` primero y `labelText` segundo y, a continuación, aplica el valor predeterminado. Los autores ven la etiqueta que establecen. (SITES-32278)
* Al cancelar el filtro Ubicación en Sites, el icono OmniSearch se desalineó y se superpuso con el texto del marcador de posición. El icono se volvió impracticable. La corrección vuelve a alinear el icono y restaura el área activa, por lo que el ratón y el teclado activan la búsqueda. (SITES-30946)
* Al elegir Desarrollador, la página se quedó en mal estado y se bloqueó la creación en esa página. El panel desapareció y la interfaz de usuario dejó de responder. La actualización repara la lógica de alternancia de modo y la administración de caché, manteniendo la página editable y mostrando los datos del desarrollador inmediatamente. (SITES-30922)
...
* En pantalla completa, el editor de texto enriquecido ocultaba el resultado de la revisión ortográfica detrás del cuadro de diálogo cuando no había errores. La actualización coloca el panel de resultados en primer plano y mantiene visibles los mensajes y las sugerencias. Los autores revisan y aceptan correcciones sin salir de pantalla completa. (SITES-32366)
* Las imágenes del editor de texto enriquecido ahora respetan la alineación seleccionada. Los autores se colocan a la izquierda, en el centro o a la derecha en el cuadro de diálogo de la imagen y el editor aplica esa opción de forma coherente en la salida. El cambio también estabiliza el cuadro de diálogo Texto alternativo, de modo que el texto alternativo y la alineación se guardan y persisten en las reediciones. (SITES-30634)

#### Editor universal {#sites-universal-editor-6524}

La configuración del Controlador de autenticación de token de consulta confundió a los usuarios porque las etiquetas no coincidían con los campos. La interfaz de usuario extrajo texto de la ruta y mostró nombres incorrectos. La corrección restaura etiquetas claras y precisas para la clasificación de servicio y las opciones de token de consulta. (SITES-31305)
...
* Los usuarios experimentaron problemas de accesibilidad con los archivos PDF generados mediante AEM Forms Designer 6.5.23 para idiomas no latinos. Las etiquetas Path no se colocaron dentro de un contenedor Artifact, lo que produjo errores en las comprobaciones de PAC y lector de pantalla. (LC-3923295)
...
* Los usuarios experimentaron problemas de accesibilidad con los formularios de documento de registro (DoR). Cuando los campos de entrada están vacíos, los lectores de pantalla solo leen las leyendas de campo y no los valores, lo que dificulta a los usuarios con discapacidades navegar por los formularios de manera efectiva. (LC-3923234)
* Los usuarios experimentaron problemas de accesibilidad en los PDF forms DoR donde NVDA anunció incorrectamente `unavailable` para casillas de verificación, botones de opción y campos de texto. El mensaje se repetía a menudo, lo que causaba confusión a los usuarios del lector de pantalla. (LC-3923201)
* Los usuarios experimentaron una discrepancia en el orden de tabulación en el XDP al agregar nuevos campos. El orden de tabulación existente ha cambiado inesperadamente, lo que afecta a la navegación de formularios. (LC-3923183, LC-3922630)
* Los usuarios experimentaron problemas con la representación del HTML. Al utilizar el evento `docReady`, no se almacenó en déclencheur correctamente en HTML, lo que provocó que los scripts no se ejecutaran según lo esperado. (LC-3923118)
...
* Los usuarios experimentaron problemas con los campos flotantes en los formularios. Cuando se utilizan archivos de datos diferentes, los campos flotantes se representan correctamente con un archivo pero no con el otro, a pesar de las pequeñas diferencias no relacionadas con los campos. (LC-3923056)
* Los usuarios experimentaron una página principal en español en blanco cuando solo se seleccionaba contenido en inglés en un XDP (paquete de datos XML) con varias páginas principales. (LC-3923009)
* Los usuarios observaron información obsoleta del año de copyright en el Designer AEM. Este error se produjo en el cuadro emergente al inicio, en la sección `About` y en la sección `Legal Notices`, que muestra `2003-2024` en lugar de &quot;2003-2025&quot;. (LC-3923005)
* Los usuarios encontraban una página de PDF en blanco al utilizar la paginación en AEM Forms Designer. El problema se produjo al seleccionar `Top of the Next Page/Top of Page` para WireAdviceHeader, interrumpiendo el diseño de las iteraciones de datos. (LC-3922997, LC-3922830)
* Los usuarios experimentaron un problema en el que el valor de compendio del archivo para la definición de esquema (XSD) del lenguaje de marcado extensible (XML) no persistía en la versión de 64 bits de AEM Forms Designer. (LC-3922924)
...
* Los usuarios experimentaron un error con el color de fondo del encabezado `Dati Richiedente` en el componente de aplicación portátil (PAC), al recibir el mensaje `path object not tagged.` (LC-3922912)
* Los usuarios han experimentado un problema por el que plantillas específicas sustituían la fuente deseada por una fuente condensada. (LC-3922330)
...
* Los usuarios experimentaron bloqueos de la aplicación al interactuar con OdataResponse debido a una excepción de puntero nulo. (FORMS-20344)
* Los usuarios experimentaron problemas al crear reglas para mostrar un panel y definir el enfoque en un elemento de su interior. La regla setFocus se ejecuta antes de actualizar la visibilidad, lo que provoca un error en la acción de enfoque. (FORMS-19563)
* Los usuarios experimentaron problemas con la selección de componentes en AEM Forms Author. Al navegar entre pestañas en el modo de edición, algunos contenedores se volvían inseleccionables, lo que impedía una fácil identificación e interacción. (FORMS-18525)
* Los usuarios experimentaron un error de `Invalid URL` al intentar realizar anotaciones en recursos en AEM 6.5.22. (NPR-42684)
...
Se ha actualizado el paquete Felix Web Console para incluir FELIX-6747. Este parche corrige el control de respuestas que anteriormente interrumpió la representación y la autenticación de la página en la consola web de OSGi. La consola se carga de forma coherente y ya no genera entradas IllegalStateException en los registros. (NPR-42730)
...
* El icono Ayuda ahora muestra una etiqueta concisa a las tecnologías de asistencia. JAWS lee `Help button` y ya no agrega palabras `menu` extrañas. Esta actualización lleva el control a la conformidad con WCAG 4.1.2 y simplifica el uso del teclado y del lector de pantalla. (GRANITE-55360)
* Restaure la fábrica del motor de scripts HTML después de eliminar un bucle de dependencia en los servicios OSGi. Los entornos se inician de forma limpia, la representación HTML funciona en todos los pods de autor y los administradores ya no encuentran errores de inicio o servicios de secuencias de comandos que faltan. (GRANITE-58276)

* El cuadro de búsqueda de encabezado ya no se superpone al icono de lupa en el texto del marcador de posición. El marcador de posición se muestra con el relleno adecuado y se puede leer por completo en todos los navegadores. (GRANITE-54391)
* Los autores ven etiquetas legibles en los campos Autocompletar en lugar de valores sin procesar en el cuadro de diálogo. La implementación mantiene el valor guardado en JCR y mejora la claridad de las configuraciones de selección única y múltiple que generan opciones dinámicamente. (GRANITE-57615)
* El modo de edición sigue siendo funcional cuando htmlLibraryManager.debug está establecido en true. El cambio restaura la resolución y carga adecuada de la biblioteca cliente, lo que permite a los desarrolladores utilizar las herramientas de depuración del Administrador de bibliotecas HTML durante la creación. (GRANITE-58002)
...
* El cuadro de diálogo del asistente para la creación de páginas ahora vuelve a validar los campos obligatorios en cada interacción, incluidos los cambios de pestaña y las ediciones de varios campos. El botón **Crear** permanece deshabilitado hasta que los autores completen todas las entradas requeridas, y el asistente muestra errores en línea para los valores que faltan. (GRANITE-58826)

#### Integraciones{#foundation-integrations-6524}

La publicación de actividades de AEM Target ya no falla cuando los autores establecen las fechas de inicio y finalización. La integración envía marcas de tiempo compatibles con los estándares que incluyen la zona horaria, por lo que Target procesa la carga útil de actividad y completa la sincronización según lo previsto. (CQ-4360733)
...
* La localización en zh-CN elimina una frase ambigua en el estado de recopilación de referencias que se muestra durante operaciones de recursos como Mover. La interfaz de usuario ahora muestra `正在获取对 [[0]] 项的引用`, lo que proporciona un significado preciso y una terminología coherente. (CQ-4354648)
* La creación de una colección inteligente ya no convierte las palabras clave de búsqueda guardadas al actualizar. Los autores que introducen términos en inglés comprueban que se conservan esos mismos términos y que la colección sigue mostrando resultados coherentes. (NPR-43158)
* Se ha corregido el texto de información sobre herramientas truncado en el panel Imagen. La descripción de `Display caption as pop-up` se representa por completo en todas las configuraciones regionales admitidas, lo que mejora la guía para los autores que no son ingleses. (SITES-10490)
* La vista de columna de administración de sitios truncó las etiquetas localizadas en francés y español. `End Time` y `Off Time` aparecieron truncados y no mostraron información de objeto. Adobe corrigió las traducciones y restauró la información del objeto al pasar el ratón por encima, por lo que las etiquetas se leyeron en su totalidad. (SITES-31318)
* El cuadro de diálogo **Mover** de Sites mostraba claves i18n sin procesar en lugar de etiquetas legibles. Los elementos como `Referencing pages,` `Created on,` `Created by,` y `Path` parecían confusos. La corrección enlaza el cuadro de diálogo con los diccionarios correctos y proporciona traducciones, con una reserva en inglés. (SITES-30881)
...
* Las etiquetas de desplazamiento en la barra de navegación ya no permanecen en la pantalla después de que el cursor se desplace fuera del control. La interfaz de usuario oculta estas informaciones sobre herramientas inmediatamente al desenfocar o desplazar el ratón, lo que evita el desorden visual y los clics erróneos. (CQ-4360030)
* En Sites, las acciones de la barra de herramientas dejan de crear una segunda ventana emergente cuando se repiten los clics. El segundo clic cierra el elemento emergente existente y deja solo una instancia visible, lo que elimina la superposición y la distracción. (CQ-4360038)
...
* Al hacer clic en una información sobre herramienta en la barra de encabezado AEM, ya no se activa la acción subyacente. Los elementos emergentes solo se abren cuando los usuarios hacen clic en el botón real, lo que evita cuadros de diálogo accidentales al interactuar con texto de información sobre herramientas. (CQ-4360105)
* La acumulación de años ya no deja texto de copyright obsoleto. La pantalla Inicio de sesión y el cuadro de diálogo **Ayuda** > **Acerca de AEM** derivan el año del reloj del sistema y presentan el valor actualizado cada vez que se carga la interfaz de usuario. (CQ-4360173)
* Los elementos emergentes de la barra de encabezado ahora se alternan correctamente. Al hacer clic en la misma acción (por ejemplo, **Buscar** o **Filtro**), se cerrará la ventana emergente de apertura en lugar de abrir otra superposición. El cambio evita las ventanas emergentes apiladas y devuelve el enfoque al control de encabezado. (NPR-42891)
...
* Se ha corregido la visibilidad del grupo en el entorno de autor. La consola Grupos ya no se detiene en unos 41 resultados y devuelve el conjunto completo de abonos para cada usuario. Esta corrección restablece el comportamiento coherente después de las correcciones acumulativas y mantiene el endurecimiento de la seguridad actual. (NPR-42749)
...
* **FORMS-23881** En implementaciones JEE de AEM Forms configuradas con el instalador completo de 6.5.23.0, el servicio de salida no procesa las solicitudes cuando se proporciona un archivo XCI personalizado en la invocación. Para resolver este problema, instale el Service Pack más reciente de AEM 6.5.24.0 Forms desde el portal [Distribución de software](https://experience.adobe.com/#/downloads/content/software-distribution/es/aem.html).
...
* [Contacte con el servicio de atención al cliente de Adobe](https://experienceleague.adobe.com/es/docs/support-resources/adobe-support-tools-guide/adobe-customer-support-experience#).
