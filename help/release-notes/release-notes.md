...
* Si un usuario intenta previsualizar un borrador de carta con datos XML guardados, se queda atascado en `Loading` para algunas letras específicas. (FORMS-14521) Para resolver el problema, realice los siguientes pasos:
   ...
   1. Cargue e instale el paquete (.zip) mediante el [Administrador de paquetes CRX](https://experienceleague.adobe.com/docs/experience-manager-65/content/sites/administering/contentmanagement/package-manager.html?lang=es#accessing).
