...
* Se ha eliminado el rol `presentation` que ocultaba la tabla de la página principal de Sites del árbol de accesibilidad. La tabla vuelve a leerse correctamente. NVDA y JAWS detectan la tabla, reconocen los encabezados y anuncian las relaciones de encabezado durante la navegación de filas y columnas. (SITES-24942)
...
* Error de cancelación de publicación para fragmentos de contenido cuya ruta DAM contenía paréntesis. El asistente Administrar publicación reescribió `(` y `)`, y rompió la ruta de acceso del recurso. La corrección conserva los caracteres y resuelve el elemento correcto, por lo que la acción de cancelar la publicación finaliza. (SITES-35077)
