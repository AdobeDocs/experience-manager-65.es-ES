...
| Área | Función | Reemplazo | Versión (SP) |
|--- |--- |--- |--- |
| Integración con [!DNL Experience Cloud] | Puede sincronizar los recursos con [!DNL Experience Cloud] uso de una configuración mediante [!DNL Adobe I/O]. [!DNL Adobe Experience Cloud] anteriormente se denominaba [!DNL Adobe Marketing Cloud]. | Si tiene alguna consulta, [póngase en contacto con el servicio de asistencia al cliente de Adobe](https://www.adobe.com/account/sign-in.supportportal.html). |  |
