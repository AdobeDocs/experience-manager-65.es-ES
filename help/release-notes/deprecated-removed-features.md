...
| Área | Funcionalidad | Reemplazo | Versión (SP) |
|--- |--- |--- |--- |
| Comercio | Se ha eliminado AEM CIF Classic. | Debe migrar a [AEM CIF](/help/commerce/cif/migration.md). Si todavía necesita CIF Classic, se ha creado un paquete de compatibilidad, [comuníquese con la atención al cliente de Adobe](https://experienceleague.adobe.com/es?support-solution=General#support). | 6.5.22.0 |
