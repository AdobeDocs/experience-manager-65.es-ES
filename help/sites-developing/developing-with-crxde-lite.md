...
description: CRXDE Lite AEM está incrustado en la interfaz de usuario de y le permite realizar tareas de desarrollo estándar en el explorador de, lo que le permite realizar tareas de desarrollo estándar en la interfaz de usuario de.
...
AEM En esta sección se describe cómo desarrollar la aplicación de mediante CRXDE Lite.
...
Se recomienda utilizar CRXDE Lite AEM cuando no tenga acceso directo al servidor de, cuando desarrolle una aplicación ampliando o modificando los componentes predeterminados y los paquetes Java o cuando no necesite un depurador dedicado, la finalización del código y el resaltado de sintaxis.
...
>[!NOTE]
>
>Se recomienda utilizar la variable [AEM Herramientas para desarrolladores para Eclipse](/help/sites-developing/aem-eclipse.md) y el [AEM Extensión de corchetes de HTL](/help/sites-developing/aem-brackets.md) durante el desarrollo del proyecto.
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p>Mostrar el estado de replicación del nodo actual. Puede replicar y replicar y eliminar el nodo actual.</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   <td>Actualizar<br /> </td>
   <td>Actualiza la selección actual. Los cambios de otros usuarios se actualizan en la vista del repositorio. Los cambios que ha realizado no se ven afectados.<br /> </td>
  </tr>
  <tr>
   <td>Guardar todos</td>
...
1. La definición, en notación cnd, se mostrará en el explorador. Guarde la información si es necesario.
...
* Anclar el mensaje en la selección actual haciendo clic en **Fijar** icono.
