...
+ Administración de experiencias sin objetivos{#headless}
   ...
   + API de entrega{#delivery-api}
      ...
      + [API de GraphQL de fragmentos de contenido](/help/sites-developing/headless/graphql-api/graphql-api-content-fragments.md)
...
+ AEM Ampliación de la{#extending-aem}
   ...
   + Forms{#extending-forms}
      + [Crear asignaciones de formularios personalizadas](extending-campaign-form-mapping.md)
