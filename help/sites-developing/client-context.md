...
>[!NOTE]
>
>Context del cliente ha sido reemplazado por ContextHub. Consulte la documentación [](/help/sites-developing/contexthub.md) relacionada para obtener más información.
...
* El servidor (consulte Tienda [](/help/sites-administering/client-context.md#main-pars-variable-8) JSONP para almacenar información de fuentes de terceros)
...
* @param {String} storeTienda que se va a procesar
* @param {String} divIdId del div en el que se debe representar la tienda.
...
Los almacenes de sesiones se crean según el `Observable` patrón. Se extienden [ que proporciona el `CQ_Analytics.Observable`](/help/sites-developing/ccjsapi.md#cq-analytics-observable) ` [addListener](/help/sites-developing/ccjsapi.md#addlistener-event-fct-scope)` método.
...
1. Abra CRXDE Lite en el navegador web ([https://localhost:4502/crx/de](https://localhost:4502/crx/de)).
...
1. Abra la página de inicio de Geometrixx Outdoors en la instancia de creación ([https://localhost:4502/content/geometrixx-outdoors/en.html](https://localhost:4502/content/geometrixx-outdoors/en.html)).
...
1. Abra la página en inglés del sitio Geometrixx Outdoors. ([https://localhost:4502/content/geometrixx-outdoors/en.html](https://localhost:4502/content/geometrixx-outdoors/en.html))
...
Para utilizar el contexto de cliente personalizado, edite la propiedad`path`en el estilo de diseño del componente de contexto de cliente, tal como se incluye en la plantilla de página. Por ejemplo, como ubicación estándar de:
