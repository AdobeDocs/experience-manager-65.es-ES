...
A partir de la versión 6.0, Adobe Experience Manager (AEM) ha introducido una nueva interfaz de usuario denominada IU ** táctil (también conocida como IU ** táctil). Está alineado con Adobe Marketing Cloud y con las directrices generales de la interfaz de usuario de Adobe. Esta se ha convertido en la interfaz de usuario estándar de AEM con la interfaz heredada orientada a equipos de escritorio denominada IU ** clásica.

Si ha estado utilizando AEM con la IU clásica, deberá realizar una acción para migrar su instancia. Esta página tiene como objetivo actuar como trampolín proporcionando vínculos a recursos individuales.

>[!NOTE]
>
>Este proyecto de migración puede tener un impacto significativo en su caso. Consulte [Administración de proyectos: prácticas recomendadas](/help/managing/best-practices.md) para obtener las directrices recomendadas.
...
<table>
 <tbody>
  ...
  <tr>
   <td>Se describe en el repositorio JCR como una estructura de nodos. Cada nodo que representa un elemento de la interfaz de usuario se denomina <em>utilidad</em> ExtJS y se procesa en el lado del cliente por <code>ExtJS</code>.</td>
...
En otras palabras, la migración de una sección de la interfaz de usuario de la IU clásica a la IU táctil significa la portación de un widget *ExtJS a un componente* ** Sling. Para facilitar esto, la IU táctil se basa en el marco de la interfaz de usuario Granite, que ya proporciona algunos componentes Sling para la interfaz de usuario (denominados componentes de la interfaz de usuario Granite).
...
* [Desarrollo de componentes](/help/sites-developing/developing-components.md) de AEM (con la IU táctil)
...
>[!NOTE]
>
>Consulte también [Desarrollo: Prácticas](/help/sites-developing/best-practices.md)recomendadas.
...
* [Tutoriales y vídeos de AEM 6.5 Sites](https://docs.adobe.com/content/help/en/experience-manager-learn/sites/overview.html)
* [Tutorial de WKND para empezar a desarrollar sitios de AEM](/help/sites-developing/getting-started.md)
* [AEM Gems](https://helpx.adobe.com/experience-manager/kt/eseminars/gems/aem-index.html)
* [Herramientas de modernización de AEM](https://opensource.adobe.com/aem-modernize-tools/)

>[!CAUTION]
>
>Las herramientas de modernización de AEM son un esfuerzo de la comunidad y Adobe no las admite ni garantiza.
