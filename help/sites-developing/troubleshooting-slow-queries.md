...
AEM El siguiente ejemplo utiliza el Generador de consultas como el lenguaje de consulta más común utilizado por los desarrolladores de, aunque los mismos principios se aplican a JCR-SQL2 y XPath.
