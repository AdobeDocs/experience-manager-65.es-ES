...
1. Cree el componente de página:
   ...
   * Establezca la `sling:resourceSuperType` propiedad en `wcm/mobile/components/page`De este modo, el componente depende del componente de página móvil.
...
* [com.day.cq.wcm.mobile.api](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/mobile/api/device/capability/package-summary.html) - define MobileConstances.
...
AEM utiliza una versión truncada de la base de datos [WURFL](https://wurfl.sourceforge.net/)™ para consultar las capacidades del dispositivo, como la resolución de pantalla o la compatibilidad con javascript, según el agente de usuario del dispositivo.
...
>[!NOTE]
>
>Para obtener más información, lea la sección [Personalizado de BrowserMap](#creatingacustomisedbrowsermap) .
