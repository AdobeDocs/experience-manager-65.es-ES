...
Al comparar versiones de una página, AEM vuelve a crear la versión anterior que el usuario desea comparar en segundo plano para facilitar la diferencia. Esto es necesario para poder representar el contenido [para una comparación](/help/sites-developing/pagediff.md#operation-details)paralela.
