...
El JavaDoc para la API de Java de JCR es [here](https://jackrabbit.apache.org/jcr/jcr-api.html).
...
**Plantilla** - En AEM, una plantilla especifica un tipo particular de página. Define la estructura de una página (aunque también suele especificar una imagen en miniatura y varias propiedades). Por ejemplo, puede tener plantillas diferentes para páginas de producto, mapas del sitio e información de contacto.
