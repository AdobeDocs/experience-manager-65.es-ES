...
* Vista: `/apps/<my-site>/components`Tanto en los entornos de autor como de publicación, el contenido se representa mediante [componentes](/help/sites-developing/components.md).
