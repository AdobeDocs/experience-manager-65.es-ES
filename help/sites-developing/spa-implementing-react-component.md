...
>[!CAUTION]
>Este documento utiliza la variable [Aplicación de diario We.Retail](https://github.com/adobe/aem-sample-we-retail-journal) únicamente con fines de demostración. No debe utilizarse para ningún trabajo de proyecto.
>
