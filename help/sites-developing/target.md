...
>[!NOTE]
>
>Solo la versión de `at.js` incluido con el producto es compatible. La versión de `at.js` enviado con el producto puede obtenerse mirando el `at.js` en la ubicación:
>
...
El JSP agrega los objetos javascript de análisis necesarios y las referencias a bibliotecas javascript del lado del cliente. El archivo testandtarget.js contiene las funciones mbox.js . El HTML que genera la secuencia de comandos es similar al siguiente ejemplo:
...
1. Vaya a CQ **Herramientas** página y seleccione **Cloud Services**. ([https://localhost:4502/libs/cq/core/content/tools/cloudservices.html](https://localhost:4502/libs/cq/core/content/tools/cloudservices.html))
...
La configuración de Target incluye un archivo mbox.js personalizado, [el código requerido en la sección del encabezado](/help/sites-developing/target.md#p-the-head-section-p) de su página agrega el archivo al marco de biblioteca del cliente en lugar de una referencia a la biblioteca testandtarget.js .
