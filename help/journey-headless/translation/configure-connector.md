...
* [Configuración del marco de integración de traducción](/help/sites-administering/tc-tic.md) - Revise una lista de conectores de traducción seleccionados y aprenda a configurar el marco de integración de traducción para integrarse con servicios de traducción de terceros.
* [Conexión al traductor de Microsoft](/help/sites-administering/tc-msconf.md) - AEM proporciona una cuenta de traducción de Microsoft de prueba para realizar pruebas.
