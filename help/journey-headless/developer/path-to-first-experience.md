...
En el documento anterior del recorrido de contenido sin encabezado de AEM, [Introducción a AEM sin encabezado ](getting-started.md) aprendió la teoría básica de lo que es un CMS sin encabezado y ahora debería poder hacer lo siguiente:
...
Antes de continuar con este documento, asegúrese de haber revisado el documento anterior en el Recorrido para desarrolladores de contenido sin encabezado de AEM, [Introducción a AEM sin encabezado ](getting-started.md) para lograr lo siguiente:
...
Independientemente de AEM, también debe asegurarse de tener configurado un entorno de desarrollo adecuado si está creando una aplicación del lado del cliente para poder probarlo frente a llamadas de API a AEM.
...
Si lo desea, también puede ver la [recursos adicionales](#additional-resources) para obtener más información sobre los temas concretos.
...
* [Desarrollo sin encabezado para AEM Sites ](/help/sites-developing/headless/introduction.md): una introducción rápida para orientar al desarrollador de AEM sin encabezado con las funciones necesarias.
