...
Para obtener las direcciones URL de los ajustes preestablecidos de visor, consulte [Vinculación de direcciones URL a la aplicación](/help/assets/linking-urls-to-yourwebapplication.md)web. Consulte también [Incrustación del visor de vídeos en una página](/help/assets/embed-code.md)Web.
