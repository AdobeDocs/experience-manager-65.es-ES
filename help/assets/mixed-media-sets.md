...
1. Pulse el Selector de recursos para seleccionar los recursos que desea incluir en su conjunto de medios mixtos. Selecciónelos y haga clic en **[!UICONTROL Select]**.
