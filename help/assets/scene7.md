...
El diseño interactivo para sus recursos significa que el recurso se adapta según dónde se muestre. Con un diseño interactivo, los mismos recursos se pueden mostrar de forma eficaz en varios dispositivos.
...
**[!UICONTROL URL, Abrir en]** : puede configurar un recurso desde para abrir un vínculo. Defina la **[!UICONTROL dirección URL]** y, en **[!UICONTROL Abrir en]**, indique si quiere que se abra en la misma ventana o en una nueva.
...
**[!UICONTROL Puntos de interrupción]** : Si el sitio web es adaptable, desea ajustar los puntos de interrupción. Los puntos de interrupción deben separarse con comas ( , ).
...
**[!UICONTROL URL, Abrir en]** : puede configurar un recurso desde para abrir un vínculo. Defina la dirección URL y, en Abrir en, indique si quiere que se abra en la misma ventana o en una nueva.
...
Para cambiar el texto dinámicamente, introduzca el nuevo texto en los campos y seleccione **[!UICONTROL OK]**. En este ejemplo, el **[!UICONTROL Precio]** es ahora $50 y el envío cuesta 99 centavos.
...
>[!NOTE]
>
>* En la interfaz de usuario clásica; también puede buscar **Flash** y **FXG**. No se admite el filtrado para estos tipos en la IU táctil optimizada.
>
>* Al buscar vídeos, se busca una sola representación. Los resultados devuelven la representación original (solo &amp;ast;.mp4) y la codificada.
