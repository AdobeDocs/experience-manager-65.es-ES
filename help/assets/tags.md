...
Consulte [Elementos de datos](https://experienceleague.adobe.com/es/docs/experience-platform/tags/ui/data-elements).
...
Ver [reglas](https://experienceleague.adobe.com/es/docs/experience-platform/tags/ui/rules).
...
**Rastrear visores de Dynamic Media mediante el código incrustado:**
...
* Los informes están disponibles para ver los datos recopilados de Adobe Analytics.
...
1. Por lo general, la configuración de un informe en Adobe Analytics depende de las necesidades específicas del proyecto. Como tal, la configuración detallada de un informe está fuera del ámbito de esta integración.
...
Después de configurar las etiquetas de Experience Platform, se configuran las siguientes opciones para la integración:
...
Consulte también [Crear una propiedad de etiquetas](https://experienceleague.adobe.com/es/docs/platform-learn/implement-mobile-sdk/initial-configuration/configure-tags).
...
Consulte [Extensión del servicio de identidad de Adobe Experience Cloud](https://experienceleague.adobe.com/es/docs/experience-platform/tags/extensions/client/id-service/overview).
...
Ver [extensión de Adobe Analytics](https://experienceleague.adobe.com/es/docs/experience-platform/tags/extensions/client/analytics/overview).
...
1. En el autor de Experience Manager, seleccione el icono **[!UICONTROL Herramientas]** (martillo) y vaya a **[!UICONTROL Seguridad]** > **[!UICONTROL Configuraciones de Adobe IMS]**.
...
1. En el autor de Experience Manager, cerca de la esquina superior izquierda, seleccione el icono **[!UICONTROL Herramientas]** (martillo) y, a continuación, vaya a **[!UICONTROL Cloud Services]** > **[!UICONTROL Configuraciones de etiquetas de Experience Platform]**.
...
Sin embargo, se admite en el nodo de publicación de Experience Manager. Con la configuración predeterminada de Experience Platform Tags Cloud Configuration, el nodo Publicación de Experience Manager utiliza el entorno de producción de Experience Platform Tags. Como tal, es necesario insertar las actualizaciones de la biblioteca de etiquetas de Experience Platform de Desarrollo al entorno de Producción cada vez durante la prueba.
...
Consulte [Integrar Experience Manager con etiquetas de Experience Platform mediante [!DNL Adobe Developer Console]](https://experienceleague.adobe.com/es/docs/experience-manager-learn/sites/integrations/experience-platform-data-collection-tags/overview) para obtener más información sobre la configuración de la nube de etiquetas de Experience Platform.
