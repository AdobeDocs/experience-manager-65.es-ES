...
Aunque las plantillas de recursos son principalmente [!DNL Adobe InDesign] archivos, la competencia en [!DNL Adobe InDesign] no es una barrera para crear artefactos estelares. No es necesario asignar los campos de la plantilla [!DNL Adobe InDesign] a los campos del producto que, de lo contrario, se requieren al crear catálogos. Puede editar las plantillas en modo WYSIWYG directamente en la interfaz web. Sin embargo, para que [!DNL Adobe InDesign] procese los cambios de edición, primero debe configurar [!DNL Experience Manager Assets] para integrarlos con [!DNL Adobe InDesign Server].

La capacidad de editar [!DNL Adobe InDesign] plantillas desde la interfaz Web ayuda a fomentar la buena colaboración entre el personal creativo y el personal de mercadotecnia. La mayor velocidad de contenido reduce el tiempo de comercialización de las garantías de marketing.
...
1. Tenga una o más plantillas INDD cargadas y disponibles con [!DNL Experience Manager] por adelantado. Elija una plantilla para el folleto y haga clic en **[!UICONTROL Siguiente]**.
...
1. Para abrir el material publicitario para la edición, realice una de las siguientes acciones:
   ...
   * Abra el colateral (folleto en este caso) que creó en el paso 7 de [Crear una colateral](/help/assets/asset-templates.md#creating-a-collateral).
   * En la página Plantillas, desplácese hasta la carpeta en la que creó el material publicitario y haga clic en la acción rápida [!UICONTROL Editar] en la miniatura de un material promocional.
   * En la página de recursos para el colateral, haga clic en **[!UICONTROL Editar]** en la barra de herramientas.
   * Seleccione el colateral y haga clic en **[!UICONTROL Editar]** en la barra de herramientas.
   ...
   Con el buscador de recursos, puede buscar o buscar imágenes dentro de [!DNL Experience Manager Assets] y reemplazar las imágenes editables en la plantilla con las imágenes que desee.

   ![chlimage_1-109](assets/chlimage_1-314.png)

   Los editables se muestran a la derecha. Para que un campo pueda editarse en [!DNL Experience Manager Assets], el campo correspondiente de la plantilla debe etiquetarse en [!DNL InDesign]. En otras palabras, deben marcarse como editables en [!DNL InDesign].

   >[!NOTE]
   >
   >Asegúrese de que la implementación [!DNL Experience Manager] esté integrada con un [!DNL InDesign Server] para permitir que [!DNL Experience Manager Assets] extraiga datos de la plantilla [!DNL InDesign] y que esté disponible para su edición. Para obtener más información, consulte [Integración de Recursos Experience Manager con InDesign Server](/help/assets/indesign.md).
...
1. Seleccione el campo de imagen de la lista de campos editables y, a continuación, arrastre una imagen deseada del selector de recursos al campo editable.
   ...
   También puede buscar imágenes mediante palabras clave, etiquetas y según su estado de publicación. Puede navegar por el repositorio [!DNL Experience Manager Assets] y navegar hasta la ubicación de la imagen deseada.
...
1. Haga clic en **[!UICONTROL Previsualización]** en la barra de herramientas para previsualización de todos los cambios. Haga clic en **[!UICONTROL Listo]** para guardar los cambios de edición en el colateral.
   ...
   >[!NOTE]
   >
   >Las opciones Previsualización y Finalizado solo se activan cuando los campos de imagen editables del material no tienen iconos que faltan. Si falta algún icono en el colateral, se debe a que [!DNL Experience Manager] no puede resolver las imágenes en la plantilla [!DNL InDesign]. Normalmente, [!DNL Experience Manager] no puede resolver las imágenes en los siguientes casos:
   >
   >* Las imágenes no están incrustadas en la plantilla subyacente [!DNL InDesign].
   ...
   >
   >Para obtener más información sobre cómo trabajar con [!DNL InDesign] documentos, consulte [optimizaciones para trabajar con documentos de InDesign en Experience Manager](https://helpx.adobe.com/experience-manager/kb/best-practices-idd-docs-aem.html).
...
## Combinar colateral {#merge-collateral}

1. En la interfaz [!DNL Experience Manager], haga clic en [!UICONTROL Recursos] en la página de navegación.
...
1. Vaya a la ubicación del material que desea combinar, haga clic en las miniaturas del material que desea combinar para seleccionarlo.
   ...
   Puede navegar por el repositorio o las colecciones [!DNL Experience Manager Assets], navegar hasta la ubicación de las plantillas que desee y seleccionarlas para combinarlas.
...
1. En la pantalla **[!UICONTROL Previsualización y reordenación]**, reorganice las plantillas si es necesario y previsualización la selección de las plantillas que se van a combinar. A continuación, haga clic en **[!UICONTROL Siguiente]** desde la barra de herramientas.
...
* El editor [!DNL InDesign] de [!DNL Experience Manager] funciona a nivel de etiqueta y todo el texto de una sola etiqueta se considera una sola entidad. Para conservar el formato y los estilos de texto al editarlos, etiquete cada párrafo (o texto con un estilo diferente) por separado.
