...
1. Pulse el icono **[!UICONTROL Editar]** (lápiz) para poder abrir la página en el editor de páginas. Asegúrese de que el modo **[!UICONTROL Edit]** está seleccionado cerca de la parte superior derecha de la página.
