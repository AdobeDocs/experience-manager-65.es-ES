...
Dynamic Media permite administrar los recursos antes de publicarlos. El trabajo con recursos en general se trata en detalle en [Uso de recursos](manage-assets.md)digitales. Los temas generales incluyen la carga, descarga, edición y publicación de recursos; visualización y edición de propiedades y búsqueda de recursos.
