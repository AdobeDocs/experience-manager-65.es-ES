...
1. Seleccione el perfil de imagen que desea editar o eliminar. Para editarlo, seleccione **[!UICONTROL Editar perfil de imagen]**. Para eliminarlo, seleccione **[!UICONTROL Eliminar perfil de imagen]**.
...
Puede aplicar un perfil de imagen a una carpeta desde el **[!UICONTROL Herramientas]** o si se encuentra en la carpeta, en **[!UICONTROL Propiedades]**. En esta sección se describe cómo aplicar perfiles de imagen a las carpetas de ambos modos.
...
Puede quitar un perfil de imagen de una carpeta desde el **[!UICONTROL Herramientas]** o si se encuentra en la carpeta, en **[!UICONTROL Propiedades]**. En esta sección se describe cómo quitar perfiles de imagen de las carpetas de ambos modos.
