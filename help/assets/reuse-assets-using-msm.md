...
| AEM 6.4 | [Haga clic aquí.](https://experienceleague.adobe.com/docs/experience-manager-64/assets/using/reuse-assets-using-msm.html?lang=en) |
...
Para usar MSM para [!DNL Assets], instalar al menos [!DNL Experience Manager] Paquete de servicio 1 de 6.5. Para obtener más información, consulte [las notas de la versión del paquete de servicio más reciente](/help/release-notes/release-notes.md).
