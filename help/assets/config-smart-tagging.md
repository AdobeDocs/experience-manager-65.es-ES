...
Antes de empezar a etiquetar recursos mediante Smart Content Services, integre [!DNL Experience Manager Assets] con la consola de Adobe Developer para aprovechar el servicio inteligente de [!DNL Adobe Sensei]. Una vez configurado, entrene el servicio con unas pocas imágenes y una etiqueta.
...
1. En la página Cloud Services, haga clic en **[!UICONTROL Configurar ahora]** bajo **[!UICONTROL Etiquetas inteligentes de recursos]**.
...
1. En el **[!UICONTROL AEM Servicio de contenido inteligente]** , utilice los siguientes valores:
   ...
   **[!UICONTROL Servidor de autorización]**: `https://ims-na1.adobelogin.com`
   ...
   Deje los demás campos en blanco por ahora (a proporcionar más adelante). Haga clic en **[!UICONTROL Aceptar]**.
...
1. Entrada [!DNL Experience Manager], vaya a **[!UICONTROL Herramientas]** > **[!UICONTROL Cloud Service]** > **[!UICONTROL Cloud Services heredados]** para abrir [!UICONTROL Cloud Services] consola.
...
1. Haga clic `com.day.cq.dam.similaritysearch.internal.impl`. Se abre **[!UICONTROL Tareas diversas de SimilaritySearch]**.

1. Haga clic `validateConfigs()`. En el **[!UICONTROL Validar configuraciones]** , haga clic en **[!UICONTROL Invocar]**.
...
* Las etiquetas inteligentes mejoradas se basan en modelos de aprendizaje de imágenes y sus etiquetas. Estos modelos no siempre son perfectos para identificar etiquetas. La versión actual del servicio de contenido inteligente tiene las siguientes limitaciones:
   ...
   * El etiquetado es compatible con las configuraciones regionales que [!DNL Experience Manager] es compatible con. Para ver una lista de idiomas, consulte [Notas de la versión de Smart Content Services](https://experienceleague.adobe.com/docs/experience-manager-64/release-notes/smart-content-service-release-notes.html).
...
>[!MORELIKETHIS]
>
>* [Información general sobre y cómo formar etiquetas inteligentes](enhanced-smart-tags.md)
