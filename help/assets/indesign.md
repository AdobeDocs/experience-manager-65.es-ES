...
Para obtener información sobre los scripts [!DNL Adobe InDesign], consulte [Documentación para desarrolladores de InDesign](https://www.adobe.com/devnet/indesign/documentation.html#idscripting)
