...
1. Añada `/aem65/author/crx-quickstart/launchpad/felix/bundle<id>/data/binaries/` path al archivo conf usando el `cat SWitchEngineLibs.conf` comando .
...
### Configurar el flujo de trabajo [!UICONTROL de recursos] de actualización de DAM {#configure-dam-asset-update-workflow}
...
1. En la interfaz de usuario de Experience Manager, seleccione **[!UICONTROL Herramientas > Flujo de trabajo > Modelos]**.
