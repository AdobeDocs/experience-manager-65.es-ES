...
Consulte también [Vincule las URL de YouTube a su aplicación web](video.md).
...
1. En el **[!UICONTROL Configuración de Dynamic Media Cloud]** página, en **[!UICONTROL URL del servicio de vídeo]**, copie la ruta URL completa. Más adelante en los pasos deberá copiar la ruta URL.
...
1. Cerca de la esquina superior izquierda de la página, seleccione **[!UICONTROL Cloud Services]** y, a continuación, seleccione el logotipo del Experience Manager y vaya a **[!UICONTROL General]** > **[!UICONTROL CRXDE Lite]**.
