...
1. Vaya al recurso estático *publicado* cuya URL desee copiar y toque el recurso para abrirlo.
...
1. En AEM, vaya a **[!UICONTROL Herramientas > Implementación > Nube > Cloud Service.]**
...
1. En la página Configuración **[!UICONTROL de]** Dynamic Media Cloud, en URL **[!UICONTROL del servicio]** de vídeo, copie toda la ruta de URL. Necesitará la ruta de URL copiada más adelante en los pasos.
...
1. Cerca de la esquina superior izquierda de la página, toque **[!Cloud Service** UICONTROL, toque el logotipo del Experience Manager y vaya a **[!UICONTROL General > CRXDE Lite.]**
...
1. En la página **[!UICONTROL Cloud Services]**, desplácese hacia abajo hasta el encabezado de **[!UICONTROL Servicios de Dynamic Media Cloud]** y, a continuación, pulse **[!UICONTROL Mostrar configuraciones.]**
1. En **[!UICONTROL Configuraciones disponibles]**, pulse el nombre de la configuración que desee.
1. En la página Configuración **[!UICONTROL de Cloud Service de]** Dynamic Media, haga lo siguiente:
