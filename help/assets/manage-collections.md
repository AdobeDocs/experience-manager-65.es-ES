...
1. Clic **[!UICONTROL Añadir]**. Un mensaje confirma que la colección se agrega a la colección de destino en el **[!UICONTROL Seleccionar destino]** página. Cierre el mensaje para completar el proceso.
