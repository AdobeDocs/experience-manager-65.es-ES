...
Los conjuntos de imágenes se designan mediante un titular con la palabra `IMAGESET`. Además, si se publica el conjunto de imágenes, se muestra la fecha de publicación, indicada por el icono **[!UICONTROL Mundo]**, junto con la fecha de la última modificación, indicada por el icono **[!UICONTROL Lápiz]**.
...
1. [Cargar las imágenes de origen principales para varias vistas](#uploading-assets-in-image-sets).
   ...
   Consulte [Dynamic Media: Formatos de imagen rasterizada compatibles](/help/assets/assets-formats.md#supported-raster-image-formats-dynamic-media) para obtener una lista de formatos admitidos por los conjuntos de imágenes.
...
1. [Crear un conjunto de imágenes](#creating-image-sets).
   ...
   También puede crear conjuntos de imágenes automáticamente mediante [ajustes preestablecidos de conjunto por lotes](/help/assets/config-dms7.md).
   >[!IMPORTANT]
   >
...
1. Añadir [Ajustes preestablecidos del visualizador de conjuntos de imágenes](/help/assets/managing-viewer-presets.md), según sea necesario.
   ...
   Vaya a **[!UICONTROL Herramientas]** > **[!UICONTROL Assets]** > **[!UICONTROL Ajustes preestablecidos de visor]** si desea crear o editar ajustes preestablecidos de visualizador.

1. (Opcional) [Ver un conjunto de imágenes](/help/assets/image-sets.md#viewing-image-sets) que se crearon mediante ajustes preestablecidos de conjunto por lotes.
1. [Previsualizar conjuntos de imágenes](/help/assets/previewing-assets.md).

   Seleccione el conjunto de imágenes y podrá previsualizarlo. Seleccione los iconos de miniaturas para examinar el conjunto de imágenes en el visor seleccionado. Puede elegir diferentes visores de la **[!UICONTROL Espectadores]** , disponible en el menú desplegable del carril izquierdo.

1. [Publicación de un conjunto de imágenes](/help/assets/publishing-dynamicmedia-assets.md).

   La publicación de un conjunto de imágenes activa la URL y el código incrustado. Además, debe [publicar cualquier ajuste preestablecido de visor personalizado](/help/assets/managing-viewer-presets.md) que ha creado. Los ajustes preestablecidos de visualizador listos para usar ya se han publicado.
...
1. [Vinculación de URL en la aplicación web](/help/assets/linking-urls-to-yourwebapplication.md) o [Incrustar el visor de vídeo o imagen](/help/assets/embed-code.md).
   ...
   Consulte [Vinculación de un conjunto de imágenes a una página web](/help/assets/linking-urls-to-yourwebapplication.md) y [Incrustar el visor de vídeo o imagen](/help/assets/embed-code.md).
...
Puede cargar imágenes para conjuntos de imágenes como lo haría [cargar cualquier otro recurso en Assets](/help/assets/manage-assets.md#uploading-assets).
...
1. Realice una de las siguientes acciones:
   ...
   * Cerca del centro de la página Editor de conjuntos de imágenes, seleccione **[!UICONTROL Pulse para abrir el Selector de recursos]**.
   Seleccione los recursos que desea incluir en el conjunto de imágenes. Los recursos seleccionados tienen un icono de marca de verificación sobre ellos. Cuando haya terminado, cerca de la esquina superior derecha de la página, seleccione **[!UICONTROL Seleccionar]**.
...
1. Al agregar recursos al conjunto, estos se agregan automáticamente en orden alfanumérico. Puede reordenar u ordenar manualmente los recursos después de agregarlos.
   ...
   Si desea cambiar una miniatura o muestra, seleccione la opción **+** **miniatura** junto a la imagen y vaya a la miniatura o muestra que desee. Cuando termine de seleccionar todas las imágenes seleccione **[!UICONTROL Guardar]**.
...
* En la búsqueda, puede seleccionar **[!UICONTROL Filtrar]** y, a continuación, expanda **[!UICONTROL Dynamic Media]** y seleccione **[!UICONTROL Conjuntos]**.
   ...
   La búsqueda devuelve conjuntos coincidentes creados manualmente en la interfaz de usuario o creados automáticamente mediante ajustes preestablecidos de conjuntos de lotes. Para los conjuntos automatizados, la búsqueda se realiza utilizando los criterios de búsqueda &quot;Comienza con&quot;, que son diferentes de la búsqueda del Experience Manager, que se basa en el uso de los criterios de búsqueda &quot;Contiene&quot;. Configuración del filtro en **[!UICONTROL Conjuntos]** es la única manera de buscar conjuntos automatizados.

   ![chlimage_1-134](assets/chlimage_1-134.png)

>[!NOTE]
>
>Puede ver los conjuntos a través de la interfaz de usuario de como se describe en [Editar conjuntos de imágenes](#editing-image-sets).
...
1. Realice una de las siguientes acciones:
   ...
   * Pase el ratón sobre un recurso de conjunto de imágenes y seleccione **[!UICONTROL Seleccionar]** (icono de marca de verificación), luego seleccione **[!UICONTROL Editar]** en la barra de herramientas.
...
1. Para editar las imágenes del conjunto de imágenes, realice una de las siguientes acciones:
   ...
   * Para añadir un recurso o actualizar un recurso existente, seleccione la **[!UICONTROL Añadir recurso]**. Vaya a un recurso, selecciónelo y, a continuación, seleccione **[!UICONTROL Seleccionar]** cerca de la esquina superior derecha de la página.
   ...
   * Para eliminar un conjunto de imágenes completo, vaya al conjunto de imágenes, selecciónelo y seleccione **[!UICONTROL Eliminar]**.
   ...
   >[!NOTE]
   >
   >Puede editar las imágenes de un conjunto de imágenes navegando hasta el conjunto y seleccionando **[!UICONTROL Definir miembros]** en el carril izquierdo y, a continuación, seleccione el icono Lápiz en un recurso individual para abrir la ventana de edición.
