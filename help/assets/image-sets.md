...
1. [Crear conjuntos de imágenes.](#creating-image-sets)
   ...
   También puede crear conjuntos de imágenes automáticamente mediante ajustes preestablecidos [de conjuntos de](/help/assets/config-dms7.md#creating-batch-set-presets-to-auto-generate-image-sets-and-spin-sets)lotes.
   >[!IMPORTANT]
   >
...
1. Agregue los ajustes preestablecidos [del visor de conjuntos de](/help/assets/managing-viewer-presets.md)imágenes según sea necesario.
...
1. (Opcional) [Visualización de conjuntos](/help/assets/image-sets.md#viewing-image-sets) de imágenes creados mediante ajustes preestablecidos de conjunto por lotes.
...
1. [Vincule direcciones URL a la aplicación](/help/assets/linking-urls-to-yourwebapplication.md) web o [incruste el visor](/help/assets/embed-code.md)de vídeo o de imágenes.
   ...
   Consulte [Vinculación de un conjunto de imágenes a una página](/help/assets/linking-urls-to-yourwebapplication.md) web e [Incrustación del visor](/help/assets/embed-code.md)de imágenes o vídeos.

Para editar conjuntos de imágenes, consulte [Edición de conjuntos de imágenes.](#editing-image-sets) Además, puede ver y editar las propiedades [del conjunto](/help/assets/managing-assets-touch-ui.md#editing-properties)de imágenes.
...
>[!NOTE]
>
>También puede crear conjuntos de imágenes automáticamente mediante ajustes preestablecidos [de conjuntos de](/help/assets/config-dms7.md#creating%20batch%20set%20presets%20to%20auto-generate%20image%20sets%20and%20spin%20sets)lotes.
