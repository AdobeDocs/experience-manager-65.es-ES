...
1. En la interfaz de usuario, seleccione la carpeta a la que desea aplicar los servicios de traducción. [!DNL Assets]
...
1. Haga clic en el [!DNL Experience Manager] logotipo y vaya a **[!UICONTROL Herramientas]** > **[!UICONTROL Implementación]** > **[!UICONTROL Cloud Service]**.
