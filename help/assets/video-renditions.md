...
Experience Manager Assets admite representaciones estáticas y dinámicas (representaciones con codificación DM) para recursos multimedia.
...
Experience Manager Assets proporciona compatibilidad con la reproducción de estas representaciones en el lado del cliente.
...
Para configurar el servidor proxy para representaciones con codificación DM, [configuración de los servicios de Dynamic Media Cloud](config-dynamic.md).
...
>[!NOTE]
>
>La reproducción de audio no funciona para archivos OGG y WAV en Microsoft® Internet Explorer 11. Un error `Invalid Source` se muestra en la página de detalles del recurso para los recursos con la extensión OGG o WAV.
>
