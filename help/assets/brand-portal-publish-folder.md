---
title: Carpetas de Publish a Brand Portal
...
## Carpetas de Publish a Brand Portal {#publish-folders-to-brand-portal-1}

1. En la interfaz de AEM Assets, pase el ratón sobre la carpeta que quiera y seleccione la opción **Publish** en las acciones rápidas.
...
1. **Publicar carpetas ahora**
   ...
   * En la barra de herramientas, seleccione **Publicación rápida**. A continuación, en el menú, seleccione **Publish to Brand Portal**.

   * En la barra de herramientas, seleccione **Administrar publicación**.

   1. De **Acción**, selecciona **Publish a Brand Portal**, de **Programación**, selecciona **Ahora** y haz clic en **Siguiente.**
   ...
   **Publicar carpetas más tarde**
   ...
   1. De **Acción**, selecciona **Publish a Brand Portal**, de **Programación** selecciona **Más tarde**.
