...
1. En la página Invalidación de **[!UICONTROL CDN: Añadir detalles]** , seleccione los recursos para la invalidación de CDN.
...
1. En la página Invalidación de **[!UICONTROL CDN: Confirmar]** , en el cuadro de lista de **[!UICONTROL URL]** , verá una lista de una o varias URL generadas a partir de la plantilla de invalidación de CDN que creó anteriormente y de los recursos que acaba de agregar.
...
| *No se especificó ninguna dirección URL para invalidarla.* | Se produce si no hay direcciones URL presentes en la página Invalidación de **[!UICONTROL CDN: Confirmar]** y toca **[!UICONTROL Enviar.]** |
