...
**Para invalidar el contenido en caché de CDN para los recursos de Dynamic Media:**
...
1. En el as a Cloud Service del Experience Manager, seleccione **[!UICONTROL Herramientas]** > **[!UICONTROL Assets]** > **[!UICONTROL Invalidación de CDN]**.
