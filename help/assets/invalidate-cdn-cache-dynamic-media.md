...
1. En la página **[!UICONTROL Invalidación de CDN: Confirmar]**, en el cuadro de lista **[!UICONTROL URL]**, verá una lista de una o más direcciones URL generadas a partir de la plantilla de invalidación de CDN que creó anteriormente y de los recursos que acaba de agregar.
