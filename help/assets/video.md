...
Consulte también [Visores para AEM Assets y Recursos Dynamic Media Classic](https://docs.adobe.com/content/help/en/dynamic-media-developer-resources/library/viewers-aem-assets-dmc/c-html5-s7-aem-asset-viewers.html) y [Visores para AEM solo](https://docs.adobe.com/content/help/en/dynamic-media-developer-resources/library/viewers-for-aem-assets-only/c-html5-aem-asset-viewers.html) en la Guía de referencia de visores de Adobe Scene7.
...
Utilice CBR si el vídeo contiene un nivel de movimiento similar en todo el vídeo. CBR se utiliza generalmente para transmitir contenido de vídeo. Consulte también [Uso de parámetros](/help/assets/video-profiles.md#using-custom-added-video-encoding-parameters)de codificación de vídeo personalizados.
...
Al omitir el perfil de procesamiento de vídeo y publicar directamente en YouTube, solo significa que el recurso de vídeo en Recursos AEM puede no obtener una miniatura visible. También significa que si se ejecuta en los modos de ejecución dynamicmedia o dynamicmedia_scene7, los vídeos que no estén codificados no funcionarán con ninguno de los tipos de recursos de Dynamic Media.
...
1. En la página Biblioteca de API, en la parte izquierda, debajo de la **[!UICONTROL Categoría]**, toque **[!UICONTROL YouTube.]** En la parte derecha de la página, toque la API de datos de **[!UICONTROL YouTube.]**
1. En la página API de datos de YouTube v3, toque **[!UICONTROL Habilitar.]**
...
La publicación de vídeos en YouTube requiere que tenga uno o más canales. Si ya ha creado un canal de YouTube, puede omitir esta tarea e ir a [Añadir las etiquetas para su publicación](/help/assets/video.md#adding-tags-for-publishing).
...
1. Con un editor de texto sin formato, abra el archivo JSON que descargó y guardó anteriormente en la tarea [Configuración](/help/assets/video.md#configuring-google-cloud-settings)de Google Cloud.
...
1. En el cuadro de diálogo Configuración de cuenta de YouTube, en el campo **[!UICONTROL Nombre de la aplicación]**, introduzca el ID del proyecto de Google.
   ...
   Especificó el ID de proyecto cuando [configuró la configuración](/help/assets/video.md#configuring-google-cloud-settings) de Google Cloud por primera vez.
...
* Para los trabajos de codificación, puede acceder a la página de configuración de todas las notificaciones por correo electrónico del flujo de trabajo de AEM en **[!UICONTROL Herramientas]** > **[!UICONTROL Operaciones]** > Consola **** web y buscar el servicio de notificación por correo electrónico del flujo de trabajo de CQ **[!UICONTROL diario.]** Consulte [Configuración de notificaciones por correo electrónico en AEM](/help/sites-administering/notification.md). Puede activar o desactivar las casillas de verificación de **[!UICONTROL Notificar al anular]** o **[!UICONTROL Notificar al completar]** según corresponda.
...
1. En la barra de herramientas en línea, toque el icono Configuración (llave inglesa). Click the **[!UICONTROL Arguments]** tab.
...
1. Puede seleccionar o borrar las siguientes casillas de verificación:
   ...
   * Finalización de publicación: incluye información sobre canales y direcciones URL
   ...
   >[!NOTE]
   >
   >Estos correos electrónicos son específicos de YouTube y se suman a las notificaciones de correo electrónico genéricas del flujo de trabajo. Como resultado, puede recibir dos conjuntos de notificaciones por correo electrónico: la notificación genérica disponible en el servicio **[!UICONTROL de notificación por correo electrónico de flujo de trabajo]** diario de CQ y una específica de YouTube según la configuración.
...
1. En el código incrustado, busque la línea con lo siguiente:
   ...
   El valor correcto del parámetro config2 se encuentra tanto en la función **Embed Code **como en la función copy **URL **1. In the URL from the copy **URL **command, the parameter to look for is `&config2=<value>` . El valor es casi siempre `companypreset`, pero en algunos casos también puede ser `companypreset-1`, `companypreset-2`, etc.
...
1. Utilice una aplicación o servicio de terceros para crear el archivo de subtítulos o subtítulos de vídeo.
   ...
   En la herramienta, en el campo **[!UICONTROL Introducir URL del archivo de vídeo]**, pegue la URL copiada del archivo de vídeo y, a continuación, haga clic en **[!UICONTROL Cargar**. Consulte [Obtención de una URL para un recurso](/help/assets/linking-urls-to-yourwebapplication.md#obtaining-a-url-for-an-asset) para obtener la URL del propio archivo de vídeo, que puede pegar en el campo **[!UICONTROL Introducir URL del archivo de vídeo.]** Internet Explorer, Chrome o Safari pueden reproducir el vídeo de forma predeterminada.
...
Todos los vídeos de AEM deben tener una miniatura asociada; no puede eliminar una miniatura sin reemplazarla. De forma predeterminada, al cargar un vídeo en AEM, se utiliza el primer fotograma como miniatura. Sin embargo, puede personalizar la miniatura para fines de marca o búsqueda visual, por ejemplo. Al personalizar una miniatura de vídeo, puede reproducir el vídeo y pausar el fotograma que desee utilizar, o bien seleccionar un recurso de imagen que ya haya cargado y *publicado* en el administrador de recursos digitales.
...
1. En la página Cambiar miniatura, realice una de las siguientes acciones:
   ...
   * Para utilizar un fotograma del vídeo como la nueva miniatura:
      ...
      * En la barra de herramientas, toque **[!UICONTROL Seleccionar marco del vídeo.]**
...
Consulte también [Acerca de las miniaturas de vídeo en el modo](/help/assets/video.md#about-video-thumbnails-in-dynamic-media-scene-mode)Dynamic Media - Scene7.
...
1. Cerca de la esquina superior izquierda de la página de CRXDE Lite, toque **[!UICONTROL Guardar todo]** y, a continuación, toque el icono de página de inicio posterior en la esquina superior izquierda para volver a AEM.
...
1. Después de cargar y publicar la imagen correctamente, en la página Cambiar miniatura, toque **[!UICONTROL Guardar cambios.]**
