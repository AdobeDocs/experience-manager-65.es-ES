...
Smart Content Service es un servicio en la nube alojado en Adobe I/O. Para utilizarlo en Adobe Experience Manager, el administrador del sistema debe integrar su instancia de Experience Manager con Adobe I/O.
...
1. En la interfaz de Experience Manager, vaya a **[!UICONTROL Herramientas > Recursos > Informes]**.
