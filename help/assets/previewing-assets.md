...
Para habilitar o deshabilitar los ajustes preestablecidos de visor en la interfaz de usuario, consulte [Administración de ajustes preestablecidos de visor](/help/assets/managing-viewer-presets.md).
...
1. Realice una de las acciones siguientes:
   ...
   * Para acercar, presione `<Tab>` para mover el foco al icono de acercar (+) y luego presione `<Enter>` una o más veces para acercarlo de forma incremental.

   * Para alejar, presione `<Tab>` para desplazar el enfoque al icono de alejar (-) y, a continuación, presione `<Enter>` una o más veces para alejarse de forma incremental.

   * Para mover la vista de un recurso *con zoom* horizontal o verticalmente, presione las teclas de flecha correspondientes.
