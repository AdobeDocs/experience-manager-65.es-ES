...
description: Aprenda a integrar las capacidades de depuración líderes del sector de Livefyre con su instancia de AEM 6.5, lo que le permite publicar en su sitio en cuestión de minutos contenido valioso generado por el usuario (UGC) desde las redes sociales.
...
Aprenda a integrar las capacidades de depuración líderes del sector de Livefyre con su instancia de AEM 6.5, lo que le permite publicar en su sitio en cuestión de minutos contenido valioso generado por el usuario (UGC) desde las redes sociales.
...
1. En el Administrador de paquetes, instale el paquete descargado. Consulte [Cómo trabajar con paquetes](/help/sites-administering/package-manager.md) para obtener más información sobre el uso de distribución de software y paquetes en AEM
...
1. Seleccione la carpeta de configuración en la que desea crear una nueva configuración de Livefyre y haga clic en **Crear**.
   ...
   >[!NOTE]
   >
   >Las carpetas deben tener configuraciones de nube habilitadas en sus propiedades para poder agregarlas a las configuraciones de Livefyre. Las carpetas de configuración se crean y administran en el [Explorador de configuración.](/help/sites-administering/configurations.md)
   >
