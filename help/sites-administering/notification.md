...
#### Personalización de plantillas de correo electrónico para notificación de foro {#customizing-email-templates-for-forum-notification}

Para personalizar la plantilla de correo electrónico en inglés para la notificación al foro:
...
Donde `<text_x>` puede ser una combinación de texto estático y variables de cadena dinámicas.

Se pueden utilizar las siguientes variables dentro de la plantilla de correo electrónico para las notificaciones del foro:
...
A continuación, configure su proveedor de OAuth SMTP siguiendo el procedimiento a continuación:
