...
AEM La manera principal de obtener un solucionador de sesión administrativa o de recursos en la era usar los métodos `SlingRepository.loginAdministrative()` y `ResourceResolverFactory.getAdministrativeResourceResolver()` proporcionados por Sling.
