...
1. Si desea que AEM recursos se carguen automáticamente a Dynamic Media Classic, debe activar esa opción y agregar Dynamic Media Classic al flujo de trabajo de recursos [!UICONTROL de actualización de] DAM. También puede cargar recursos manualmente.
