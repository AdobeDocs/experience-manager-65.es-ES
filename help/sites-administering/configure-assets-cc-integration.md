...
>[!NOTE]
>
>Esta función está en desuso en [!DNL Assets]. Busque reemplazos en [Prácticas recomendadas de integración de AEM y Creative Cloud](/help/assets/aem-cc-integration-best-practices.md). Si tiene alguna consulta, [póngase en contacto con el servicio de asistencia al cliente de Adobe](https://www.adobe.com/account/sign-in.supportportal.html).
...
1. Haga clic en **[!UICONTROL Crear]**. Un mensaje notifica que se ha creado la aplicación.
   ...
   ![Notificación de la creación correcta de la aplicación para integrar AEM Assets con el Creative Cloud](assets/chlimage_1-50.png)
