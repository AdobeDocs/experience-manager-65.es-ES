...
AEM incorporación al [!DNL Admin Console] permitirá a AEM clientes de Managed Services administrar todos los usuarios de Experience Cloud en una consola. Los usuarios y grupos se pueden asignar a perfiles de producto asociados con instancias de AEM, lo que les permite iniciar sesión en una instancia específica.
