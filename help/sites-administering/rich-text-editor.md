---
title: 'Configuración del editor de texto enriquecido para crear contenido en AEM '
description: Aprenda a configurar el editor de texto enriquecido de AEM para que cree contenido en AEM.
...
>* Acerca de la desaprobación de la IU clásica, consulte Notas de la versión de [AEM 6.5](/help/release-notes/deprecated-removed-features.md)
...
| [claves](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.rte.plugins.KeyPlugin) |  | Para definir este valor, consulte Tamaño [de tabulación](/help/sites-administering/configure-rich-text-editor-plug-ins.md#tabsize). |
...
| Paraformat | parformat | Los formatos de párrafo predeterminados son Párrafo, Encabezado 1, Encabezado 2 y Encabezado 3 (`<p>`, `<h1>`, `<h2>`y `<h3>`). Puede [agregar más formatos](/help/sites-administering/configure-rich-text-editor-plug-ins.md#paraformats) de párrafo o ampliar la lista. |
...
| estilos | estilos | Compatibilidad con estilos mediante una clase CSS. [Agregue nuevos estilos](/help/sites-administering/configure-rich-text-editor-plug-ins.md#textstyles) de texto si desea agregar (o ampliar) su propia gama de estilos para utilizarlos con texto. |
...
**Ejemplo**: Descargue [esta configuración](/help/sites-administering/assets/rte-sample-all-features-enabled-10.zip) de muestra que ilustra cómo configurar RTE. En este paquete todas las funciones están habilitadas.

>[!NOTE]
>
>El componente [de texto Componentes](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/text.html#the-text-component-and-the-rich-text-editor) principales permite a los editores de plantillas configurar muchos complementos RTE en una interfaz gráfica de usuario como políticas de contenido, lo que elimina la necesidad de una configuración técnica. Las políticas de contenido pueden funcionar con las configuraciones de la interfaz de usuario de RTE como se describe en este documento.
>
>Para obtener más información, consulte la sección Configuración de la interfaz de usuario de [RTE y políticas](/help/sites-administering/rich-text-editor.md) de contenido de este documento, así como [Creación de plantillas](/help/sites-authoring/templates.md) de página y la documentación [para desarrolladores de componentes](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/developing/developing.html)principales.
...
Para obtener más información sobre la configuración de RTE, consulte la referencia de la API [de utilidades de](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.RichText) AEM.
...
* El componente RichText proporciona una amplia gama de funciones mediante complementos enumerados en [CQ.form.rte.plugins.Plugin](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.rte.plugins.Plugin). Para cada complemento:
...
Se pueden usar para ampliar y personalizar su propio RTE. Por ejemplo, para enumerar los anclajes disponibles en la página al crear un vínculo, puede proporcionar su propia implementación del `LinkPlugin`.
...
Para seleccionar varias celdas en una tabla, presione `Ctrl` o `Cmd` tecla y, a continuación, haga clic en las celdas de la tabla una por una.
...
Agregue un hipervínculo en un componente de texto editándolo con el botón Configurar. Puede perder el hipervínculo cuando lo edite de nuevo y lo valide por segunda vez.
...
Si se guarda en CRXDE pero no se procesa en la página (para comprobar el procesamiento, consulte la [vista previa](/help/sites-authoring/editing-content.md#preview-mode)de la página, las reglas XSS de AEM la eliminan.
...
Si las actualizaciones de las configuraciones de interfaz se reflejan para los administradores pero no para las cuentas de creación, asegúrese de que no se asigne un nombre al nodo de configuración `config`. Utilice la [`configPath` propiedad](/help/sites-developing/components-basics.md#cq-inplaceediting).
