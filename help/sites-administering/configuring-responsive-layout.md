...
Esto le permite crear y editar sitios web interactivos que reorganizan el diseño en función del tamaño del dispositivo o la ventana, mediante el redimensionado activo de los componentes. A continuación, el usuario puede ver cómo se representa el contenido mediante el emulador.
...
Para incluir el emulador, vincule el sitio a los grupos de dispositivos. Consulte [Adición de la lista de dispositivos](/help/sites-developing/responsive.md#adding-the-devices-list) (para la IU clásica y la táctil optimizada).
...
* Se puede definir:
   ...
   * En la plantilla de página, desde donde la configuración se copia en cualquier página creada con esa plantilla.
   * En el nodo de página, desde el que cualquier página secundaria hereda la configuración.

* Defina un título y una anchura:

   * El título describe la agrupación genérica del dispositivo, con la orientación si es necesario; por ejemplo, phone, tableta, tabletscape.
...
Para que el parsys principal de la página sea un contenedor de diseño, defina parsys como:
...
También debe crear un [biblioteca cliente](https://experienceleague.adobe.com/docs/) para proporcionar configuración adicional y llamadas a funciones. El siguiente extracto LESS es un ejemplo del mínimo que debe añadir al proyecto:
...
Los componentes que se mantienen dentro de un contenedor interactivo se cambian de tamaño (junto con sus respectivos elementos DOM de HTML) según el tamaño de cuadrícula adaptable. Por lo tanto, en estas circunstancias, se recomienda evitar (o actualizar) las definiciones de elementos DOM de ancho fijo (contenidos).
