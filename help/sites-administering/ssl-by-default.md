...
A continuación, se muestra un ejemplo para crear un certificado autofirmado en formato DER que puede utilizar el Asistente para SSL. Instale OpenSSL basado en el sistema operativo, abra el símbolo del sistema OpenSSL y cambie el directorio a la carpeta donde desee generar el certificado o clave privada.
