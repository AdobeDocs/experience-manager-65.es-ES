...
description: Obtenga más información acerca de la integración de Adobe Experience Manager AEM () con otros servicios de Adobe o de terceros.
...
>[!NOTE]
>
>AEM Si utiliza una configuración proxy personalizada junto con su integración, debe configurar ambas configuraciones proxy del cliente HTTP, ya que algunas funcionalidades de las API 3.x y otras de las API 4.x se utilizan en la mayoría de los casos. Se trata de las siguientes:
>
