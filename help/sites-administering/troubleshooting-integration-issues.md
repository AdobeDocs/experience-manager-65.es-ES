...
Si la respuesta contiene la línea `a4tEnabled:false`, póngase en contacto con el servicio de atención al cliente de [Adobe](https://helpx.adobe.com/contact.html) para que se aprovisione correctamente su cuenta.
