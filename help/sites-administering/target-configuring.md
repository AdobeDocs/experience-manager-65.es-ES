...
1. Haga clic en **Conectar a Destinatario** para inicializar la conexión con Destinatario. Si la conexión es correcta, se muestra el mensaje **Conexión correcta**. Haga clic en **Aceptar** en el mensaje y, a continuación, **Aceptar** en el cuadro de diálogo.
...
1. En el cuadro de diálogo Crear marco, especifique un **Título**, seleccione el **Adobe Target Framework** y haga clic en **Crear**.
   ...
   Se abre la página del marco. La barra de tareas proporciona componentes que representan información de [Client Context](/help/sites-administering/client-context.md) o [ContextHub](/help/sites-developing/ch-configuring.md) que puede asignar.
